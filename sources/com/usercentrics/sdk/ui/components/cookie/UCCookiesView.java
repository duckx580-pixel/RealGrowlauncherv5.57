...
public final class UCCookiesView extends ConstraintLayout {
    ...
    /* JADX INFO: renamed from: com.usercentrics.sdk.ui.components.cookie.UCCookiesView$loadInformation$1, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-cf66f36031e302b9a7b5a76da57d208ae1b6ba4a38bba3bee1d4ed6983c54df3 */
    public static final class AnonymousClass1 extends m implements c {
        final UCCookiesView this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass1(UCCookiesView uCCookiesView) {
            super(1);
        ...
        public final void invoke(List<PredefinedUIDeviceStorageContent> list) {
            ...
            this.this$0.showCookieInfo(list);
        }
    }

    /* JADX INFO: renamed from: com.usercentrics.sdk.ui.components.cookie.UCCookiesView$loadInformation$2, reason: invalid class name */
    /* JADX INFO: compiled from: r8-map-id-cf66f36031e302b9a7b5a76da57d208ae1b6ba4a38bba3bee1d4ed6983c54df3 */
    public static final class AnonymousClass2 extends m implements a {
        final UCCookiesView this$0;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        public AnonymousClass2(UCCookiesView uCCookiesView) {
            super(0);
            this.this$0 = uCCookiesView;
        }
    ...
    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
    public UCCookiesView(Context context, UCThemeData uCThemeData, UCCookiesViewModel uCCookiesViewModel) {
        super(context);
        l.f("context", context);
        l.f("theme", uCThemeData);
        l.f("viewModel", uCCookiesViewModel);
        this.theme = uCThemeData;
        this.viewModel = uCCookiesViewModel;
        this.ucCookieDialogTitle$delegate = b.q(new UCCookiesView$ucCookieDialogTitle$2(this));
        this.ucCookieLoadingText$delegate = b.q(new UCCookiesView$ucCookieLoadingText$2(this));
        this.ucCookieTryAgainBtn$delegate = b.q(new UCCookiesView$ucCookieTryAgainBtn$2(this));
        this.ucCookieRetryMessage$delegate = b.q(new UCCookiesView$ucCookieRetryMessage$2(this));
        this.ucCookieLoadingBox$delegate = b.q(new UCCookiesView$ucCookieLoadingBox$2(this));
        this.ucCookieRetryBox$delegate = b.q(new UCCookiesView$ucCookieRetryBox$2(this));
        this.ucCookieDialogList$delegate = b.q(new UCCookiesView$ucCookieDialogList$2(this));
        this.ucCookieDialogClose$delegate = b.q(new UCCookiesView$ucCookieDialogClose$2(this));
        setPadding();
        inflateView();
        applyTheme();
        bindContent();
    ...
    private final void bindContent() {
        ...
        getUcCookieDialogClose().setOnClickListener(new View.OnClickListener(this) { // from class: com.usercentrics.sdk.ui.components.cookie.UCCookiesView$$ExternalSyntheticLambda1
            public final UCCookiesView f$0;
    ...
    public static final void bindContent$lambda$3(UCCookiesView uCCookiesView, View view) {
        l.f("this$0", uCCookiesView);
    ...
    public final void showRetry() {
        ...
        getUcCookieTryAgainBtn().setOnClickListener(new View.OnClickListener(this) { // from class: com.usercentrics.sdk.ui.components.cookie.UCCookiesView$$ExternalSyntheticLambda0
            public final UCCookiesView f$0;
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public static final void showRetry$lambda$4(UCCookiesView uCCookiesView, View view) {
        l.f("this$0", uCCookiesView);
        uCCookiesView.loadInformation();
    }
}
