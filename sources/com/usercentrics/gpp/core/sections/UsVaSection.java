...
public final class UsVaSection extends UsStateSection {
    public static final Companion Companion = new Companion(null);
    private final List<FieldDefinition> coreFieldDefinitions;
    private final int sectionId = 9;
    private final String sectionName = "usva";
    ...
    public static final class Companion {
        ...
        public final UsVaSection decode(String str) throws GppFieldError {
            l.f("encodedString", str);
            UsVaSection usVaSection = new UsVaSection();
            usVaSection.decodeWithGpc(str);
            return usVaSection;
        }
