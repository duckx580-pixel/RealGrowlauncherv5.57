...
public final class GeobFrame extends Id3Frame {
    ...
    public GeobFrame(Parcel parcel) {
        super(A00(36, 4, R.styleable.AppCompatTheme_windowActionBar));
    ...
    public final boolean equals(@Nullable Object obj) {
        ...
        if (C0431Hl.A0g(this.A02, geobFrame.A02) && C0431Hl.A0g(this.A01, geobFrame.A01)) {
            String str = this.A00;
            if (A05[4].length() == 21) {
                throw new RuntimeException();
            }
            A05[7] = "9rXxnJ3UHnS";
            if (C0431Hl.A0g(str, geobFrame.A00) && Arrays.equals(this.A03, geobFrame.A03)) {
                return true;
            }
        }
        return false;
