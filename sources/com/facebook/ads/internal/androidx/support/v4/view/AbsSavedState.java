...
public abstract class AbsSavedState implements Parcelable {
    ...
    static {
        ...
        CREATOR = new Parcelable.ClassLoaderCreator<AbsSavedState>() { // from class: com.facebook.ads.redexgen.X.2h
            ...
            public final AbsSavedState createFromParcel(Parcel parcel, ClassLoader classLoader) {
                ...
                throw new IllegalStateException(A02(0, 23, R.styleable.AppCompatTheme_windowMinWidthMinor));
            }
    ...
    public AbsSavedState(Parcelable parcelable) {
        ...
        throw new IllegalArgumentException(A00(0, 27, R.styleable.AppCompatTheme_textColorSearchUrl));
    }
