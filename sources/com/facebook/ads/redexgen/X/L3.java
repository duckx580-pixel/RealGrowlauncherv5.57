...
public final class L3 {
    ...
    public static String[] A01 = {"jOafuIGjbmGqGJCoIRCXQtou", "4aVS6XGMEh0UEp1LrL0", "WT7BdI1qWTWyKDUxoAWdDMpw07Ptfw8", "q0ourOn8MOENNWhqaGRKGcv5B4gp2pTE", "Hqz5MCTyQHD2ORxnmIkx6S6it7H3yU", "Fz45vwCH8U7UwOfOH", PredefinedUICustomizationFont.defaultFamily, "zqPhk"};
    ...
    public static L2 A00(Context context) {
        ...
        NetworkInfo activeNetworkInfo = ((ConnectivityManager) context.getSystemService(A01(39, 12, R.styleable.AppCompatTheme_tooltipForegroundColor))).getActiveNetworkInfo();
