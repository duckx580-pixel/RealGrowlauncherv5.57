...
public final class ZF extends AbstractC00230p {
    ...
    @Nullable
    public View A01;
    public EnumC00330z A02;
    public AnonymousClass10 A03;
    public EnumC0464Iu A04;
    ...
    public ZF(C0823Wy c0823Wy, AbstractC00240q abstractC00240q, C0640Pt c0640Pt, ZO zo) {
        super(c0823Wy, abstractC00240q, c0640Pt);
        this.A02 = EnumC00330z.A03;
        this.A03 = null;
        this.A0D = zo;
    }
    ...
    private String A02(View view) {
        try {
            ...
            return A01(0, 14, R.styleable.AppCompatTheme_viewInflaterClass);
        }
    }
    ...
    */
    private org.json.JSONObject A04(android.view.View r10) throws org.json.JSONException {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.ZF.A04(android.view.View):org.json.JSONObject");
    }
    ...
    public final void A06(Map<String, String> map) {
        ...
        EnumC0464Iu enumC0464Iu = this.A04;
        if (enumC0464Iu != null) {
            map.put(A01(97, 3, 121), String.valueOf(enumC0464Iu.A04()));
        }
        if (this.A07) {
            map.put(A01(83, 3, 95), Boolean.TRUE.toString());
        }
        if (this.A0B) {
            map.put(A01(89, 3, R.styleable.AppCompatTheme_windowActionBarOverlay), Boolean.TRUE.toString());
        }
        if (this.A08) {
        ...
        if (this.A0A) {
            map.put(A01(86, 3, R.styleable.AppCompatTheme_textColorSearchUrl), Boolean.TRUE.toString());
        }
        EnumC00330z enumC00330z = this.A02;
        if (enumC00330z != null) {
            map.put(A01(R.styleable.AppCompatTheme_toolbarNavigationButtonStyle, 14, 33), enumC00330z.toString());
        }
        if (this.A09) {
        ...
        if (this.A0C) {
            map.put(A01(78, 5, R.styleable.AppCompatTheme_tooltipForegroundColor), Boolean.TRUE.toString());
        }
        this.A0D.A0O(map);
    }
    ...
    public final void A09(EnumC00330z enumC00330z) {
        this.A02 = enumC00330z;
    }
    ...
    public final void A0B(EnumC0464Iu enumC0464Iu) {
        this.A04 = enumC0464Iu;
    }
    ...
    public final void A0F(boolean z3) {
        this.A08 = z3;
    }

    public final void A0G(boolean z3) {
        this.A09 = z3;
    }
    ...
    public final void A0J(boolean z3) {
        this.A0C = z3;
    }
}
