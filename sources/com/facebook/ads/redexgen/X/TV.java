...
public class TV extends AbstractRunnableC0488Ju {
    ...
    public final void A06() {
        ...
        try {
            ...
            if (all.size() > 1) {
                C0448Ie.A06(this.A00, QH.A00(this.A00), all);
            }
            ...
            this.A00.A06().A8u(A00(31, 14, 7), 3502, new C01897m(t10));
            sharedPreferences.edit().clear().apply();
        }
        synchronized (C0448Ie.class) {
            SharedPreferences.Editor editorEdit = sharedPreferences.edit();
            for (Map.Entry entry : C0448Ie.A02().entrySet()) {
