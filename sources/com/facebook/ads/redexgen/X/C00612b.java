...
public final class C00612b<K, V> implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
    public static byte[] A04;
    public static String[] A05 = {"XqZAhum", "ZDgQMvtBgNrA71zPtdKPERKXDyY", PredefinedUICustomizationFont.defaultFamily, "fQnh1QnAdjSL19mcL6hVXdKAmOMxUcoe", "Jl6IPYfhih6t3CzPawLUV", "5ptyQxfboOWL43Tud8kOlHSoYTCJZrHB", "GBGqVCnWWQQidVcjkSktabcuIfs5iNWm", "2xozQVjtj3EM4viJRxfTyERGPuYGzhPM"};
    public int A00;
    public final /* synthetic */ AbstractC00632d A03;
    ...
    public C00612b(AbstractC00632d abstractC00632d) {
        this.A03 = abstractC00632d;
        this.A00 = abstractC00632d.A04() - 1;
    }
    ...
    public final int hashCode() {
        if (this.A02) {
            ...
            int iHashCode = (value != null ? value.hashCode() : 0) ^ (objA07 == null ? 0 : objA07.hashCode());
            if (A05[4].length() != 21) {
    ...
    public final V setValue(V v6) {
        if (this.A02) {
            return (V) this.A03.A08(this.A01, v6);
        }
        throw new IllegalStateException(A00(1, 59, 24));
    }
    ...
    public final String toString() {
        return getKey() + A00(0, 1, R.styleable.AppCompatTheme_windowFixedHeightMinor) + getValue();
    }
}
