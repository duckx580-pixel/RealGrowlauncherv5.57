...
public final class C0448Ie {
     ...
     */
    public static void A06(C7G c7g, InterfaceC0646Pz interfaceC0646Pz, Map<String, ?> map) throws JSONException {
        HashMap map2 = new HashMap();
        map2.put(A01(93, 7, R.styleable.AppCompatTheme_tooltipFrameBackground), A01(13, 1, 41));
        A09(c7g, map2);
        HashMap map3 = new HashMap();
        map3.put(A01(188, 7, 10), A01(157, 14, 92));
        map3.put(A01(195, 12, 97), String.valueOf(3501));
        map3.put(A01(100, 16, 39), A01(14, 1, 55));
        map3.put(A01(178, 10, 39), A01(65, 13, R.styleable.AppCompatTheme_windowFixedWidthMinor));
        ...
        A09(c7g, map3);
        C8B c8bA07 = c7g.A07();
        JSONObject jSONObjectA05 = C01907n.A05(new C01927p(c8bA07.A01(), c8bA07.A02(), map3));
        JSONArray jSONArray = new JSONArray();
        jSONArray.put(jSONObjectA05);
        JSONObject jSONObject2 = new JSONObject();
        jSONObject2.put(A01(147, 4, 46), new JSONObject(map2));
        jSONObject2.put(A01(151, 6, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle), jSONArray);
        QD qd2 = new QD();
        qd2.put(A01(171, 7, 16), jSONObject2.toString());
        interfaceC0646Pz.AD6(c7g.A03().A6c(), qd2.A08(), new TU(c7g));
    }
    ...
    static {
        A04();
        A02 = C0448Ie.class.getSimpleName();
    ...
    public static void A05(C7G c7g) {
        ...
        synchronized (C0448Ie.class) {
            if (A04.get() != 0) {
                return;
            }
            A04.set(1);
            LJ.A06.execute(new TV(c7g));
        }
    }
    ...
    public static void A08(C7G c7g, String str) {
        ...
        synchronized (C0448Ie.class) {
            if (A04.get() != 2) {
                ...
                SharedPreferences sharedPreferences = c7g.getApplicationContext().getSharedPreferences(ProcessUtils.getProcessSpecificName(A01(R.styleable.AppCompatTheme_windowFixedWidthMajor, 31, R.styleable.AppCompatTheme_textColorAlertDialogListItem), c7g), 0);
