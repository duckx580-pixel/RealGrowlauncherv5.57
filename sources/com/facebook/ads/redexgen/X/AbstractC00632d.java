...
public abstract class AbstractC00632d<K, V> {
    ...
    public abstract V A08(int i10, V v6);
    ...
    public abstract void A0F(K k10, V v6);
        ...
        if (this.A02 == null) {
            this.A02 = new Collection<V>() { // from class: com.facebook.ads.redexgen.X.2c
                ...
                public final boolean removeAll(Collection<?> collection) {
                    ...
                    int i10 = 0;
                    while (i10 < iA04) {
                        if (collection.contains(this.A00.A07(i10, 1))) {
                            this.A00.A0E(i10);
                            i10--;
                            iA04--;
                            z3 = true;
        ...
        if (this.A00 == null) {
            this.A00 = new Set<Map.Entry<K, V>>() { // from class: com.facebook.ads.redexgen.X.2Z
                ...
                public final boolean contains(Object obj) {
                    ...
                    Object foundVal = this.A00.A07(index, 1);
                ...
                public final boolean equals(Object obj) {
                    return AbstractC00632d.A03(this, obj);
                }
                ...
                public final int hashCode() {
                    ...
                    for (int iA04 = this.A00.A04() - 1; iA04 >= 0; iA04--) {
                        ...
                        int result = objA07 == null ? 0 : objA07.hashCode();
                        if (objA072 != null) {
    ...
    public final Set<K> A0C() {
        if (this.A01 == null) {
            this.A01 = new Set<K>() { // from class: com.facebook.ads.redexgen.X.2a
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean containsAll(Collection<?> collection) {
                    return AbstractC00632d.A00(this.A00.A0A(), collection);
                }
                ...
                public final int hashCode() {
                    ...
                    for (int i11 = result - 1; i11 >= 0; i11--) {
                        int i12 = 0;
                        Object objA07 = this.A00.A07(i11, 0);
                        if (objA07 != null) {
                            i12 = objA07.hashCode();
                        }
                        i10 += i12;
                ...
                @Override // java.util.Set, java.util.Collection
                public final boolean removeAll(Collection<?> collection) {
                    return AbstractC00632d.A01(this.A00.A0A(), collection);
                }

                /* JADX WARN: Generic types in debug info not equals: com.facebook.ads.redexgen.X.2a != com.facebook.ads.internal.androidx.support.v4.util.MapCollections<K, V>$KeySet */
                @Override // java.util.Set, java.util.Collection
                public final boolean retainAll(Collection<?> collection) {
                    return AbstractC00632d.A02(this.A00.A0A(), collection);
                }
