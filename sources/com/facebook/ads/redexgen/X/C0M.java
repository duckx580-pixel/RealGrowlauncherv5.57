...
public final class C0M {
    ...
    @Nullable
    @SuppressLint({"CatchGeneralException"})
    public static Bitmap A03(String str, int i10, int i11, boolean z3) throws IOException {
        try {
    ...
    public static String A05(@Nullable File file) {
        if (file != null) {
            return A04(0, 7, R.styleable.AppCompatTheme_windowFixedWidthMinor) + file.getPath();
        }
        return null;
    }
