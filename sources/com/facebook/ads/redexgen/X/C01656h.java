...
public final class C01656h extends MC {
    ...
    public final AbstractC0536Ls A01;
    public final AbstractC0503Kl A02;
    public final KV A03;
    ...
    public C01656h(C0823Wy c0823Wy) {
        super(c0823Wy);
        this.A00 = null;
        this.A01 = new AbstractC0536Ls() { // from class: com.facebook.ads.redexgen.X.6l
        ...
        this.A02 = new AbstractC0503Kl() { // from class: com.facebook.ads.redexgen.X.6k
            public static byte[] A01;
            ...
            public final void A03(C01746s c01746s) {
                ((AudioManager) this.A00.getContext().getApplicationContext().getSystemService(A00(0, 5, R.styleable.AppCompatTheme_windowActionModeOverlay))).abandonAudioFocus(this.A00.A00 == null ? null : (AudioManager.OnAudioFocusChangeListener) this.A00.A00.get());
                String[] strArr = A02;
