...
public final class IQ {
    ...
    public IQ(C7G c7g, String str, double d10, String str2, @Nullable Map<String, String> map, IV iv, IW iw, boolean z3) {
        this.A05 = str;
        this.A00 = d10;
        this.A04 = str2;
        this.A02 = iv;
        ...
        if (z3) {
            map2.put(A00(27, 24, 34), String.valueOf(z3));
        }
        String strA01 = C0447Id.A01(str);
        if (!TextUtils.isEmpty(strA01) && (z3 || iw == IW.A0C)) {
            map2.put(A00(6, 21, 61), strA01);
        }
        if (A0B()) {
            Map<String, String> extraData = c7g.A02().A5g();
            map2.put(A00(0, 6, 63), C0501Kj.A01(extraData));
        }
