...
public final class C6J {
    ...
    public static void A02(C7G c7g, AnonymousClass69 anonymousClass69, int i10, String str, long j) {
        if (!A06(c7g)) {
            return;
        }
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(R.styleable.AppCompatTheme_windowNoTitle, 14, 2), anonymousClass69.A00);
            jSONObject.put(A00(134, 13, R.styleable.AppCompatTheme_windowMinWidthMajor), anonymousClass69.A01);
            if (j > 0) {
            ...
            c01897m.A03(1);
            c7g.A06().A8v(A00(154, 5, 17), i10, c01897m);
    ...
    public static void A03(C7G c7g, C6E c6e, String str, int i10, @Nullable String str2, @Nullable Long l10, @Nullable Long l11) {
        if (A06(c7g)) {
            A05(c7g, c6e.A05, c6e.A06, c6e.A07, A00(186, 5, R.styleable.AppCompatTheme_windowActionBar), str, i10, str2, l10, l11, null);
        }
    }

    @SuppressLint({"CatchGeneralException"})
    public static void A04(C7G c7g, C6I c6i, boolean z3) {
        if (!A06(c7g)) {
            return;
        }
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(R.styleable.AppCompatTheme_windowNoTitle, 14, 2), c6i.A01);
            jSONObject.put(A00(134, 13, R.styleable.AppCompatTheme_windowMinWidthMajor), c6i.A03);
            jSONObject.put(A00(R.styleable.AppCompatTheme_textColorAlertDialogListItem, 16, 42), c6i.A02);
            jSONObject.put(A00(159, 13, R.styleable.AppCompatTheme_windowMinWidthMinor), c6i.A00);
            if (ID.A1n(c7g)) {
                jSONObject.put(A00(200, 3, 82), c6i.A04);
            }
            String strA00 = z3 ? A00(61, 10, 0) : A00(71, 11, 55);
            int i10 = z3 ? A05 : A06;
            C01897m c01897m = new C01897m(strA00);
            c01897m.A05(jSONObject);
            c01897m.A03(1);
            c7g.A06().A8v(A00(154, 5, 17), i10, c01897m);
        } catch (Throwable th2) {
    ...
    public static void A05(C7G c7g, String str, String str2, String str3, String str4, String str5, int i10, @Nullable String str6, @Nullable Long l10, @Nullable Long l11, @Nullable Integer num) {
        try {
            JSONObject jSONObject = new JSONObject();
            jSONObject.put(A00(R.styleable.AppCompatTheme_windowNoTitle, 14, 2), str);
            jSONObject.put(A00(134, 13, R.styleable.AppCompatTheme_windowMinWidthMajor), str2);
            jSONObject.put(A00(R.styleable.AppCompatTheme_textColorAlertDialogListItem, 16, 42), str4);
            if (str6 != null) {
            ...
            jSONObject.put(A00(159, 13, R.styleable.AppCompatTheme_windowMinWidthMinor), str5);
            if (ID.A1n(c7g)) {
            ...
            C01897m c01897m = new C01897m(message);
            c01897m.A05(jSONObject);
            c01897m.A03(1);
            c7g.A06().A8v(A00(154, 5, 17), i10, c01897m);
        } catch (Throwable th2) {
    ...
    public static boolean A06(C7G c7g) {
        ...
        return iA06 <= 0 || c7g.A07().A00() <= 1.0d / ((double) iA06);
    }
}
