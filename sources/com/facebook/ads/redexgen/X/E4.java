...
public class E4 extends Y8 {
    ...
    public final void A03(ViewParent viewParent, View view) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(323, 55, 53), e8);
        }
    }
    ...
    public final void A04(ViewParent viewParent, View view, int i10, int i11, int i12, int i13) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(157, 51, 25), e8);
        }
    }
    ...
    public final void A05(ViewParent viewParent, View view, int i10, int i11, int[] iArr) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu, 54, 31), e8);
        }
    }
    ...
    public final void A06(ViewParent viewParent, View view, View view2, int i10) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(208, 59, 57), e8);
        }
    }
    ...
    public final boolean A07(ViewParent viewParent, View view, float f9, float f10) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(50, 53, R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu), e8);
            return false;
        }
    }

    @Override // com.facebook.ads.redexgen.X.C3N
    public final boolean A08(ViewParent viewParent, View view, float f9, float f10, boolean z3) {
        try {
            return viewParent.onNestedFling(view, f9, f10, z3);
        } catch (AbstractMethodError e8) {
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(0, 50, 85), e8);
            return false;
        }
    }
    ...
    public final boolean A09(ViewParent viewParent, View view, View view2, int i10) {
        try {
            ...
            Log.e(A01(389, 16, 60), A01(378, 11, 39) + viewParent + A01(267, 56, 75), e8);
            return false;
        }
    }
}
