...
public final class IB {
    ...
    public IB(C0823Wy c0823Wy, String str, String str2) {
        this.A03 = c0823Wy;
        this.A05 = str;
        this.A04 = str2;
    }
    ...
    /* JADX INFO: Access modifiers changed from: private */
    public void A07(int i10, C01897m c01897m) {
        this.A03.A06().A8u(A05(189, 14, 74), i10, c01897m);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public void A08(int i10, C01897m c01897m) {
        c01897m.A03(1);
        this.A03.A06().A8v(A05(189, 14, 74), i10, c01897m);
    }

    public final void A0C() {
        A08(C01887l.A1s, new C01897m(A05(R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle, 18, 66), this.A05));
        Intent intent = new Intent();
        intent.setClassName(A05(170, 19, 125), A05(R.styleable.AppCompatTheme_windowMinWidthMinor, 51, 26));
        try {
            if (!this.A03.bindService(intent, this.A02, 1)) {
                A08(C01887l.A1o, new C01897m(A05(51, 50, 11)));
                this.A03.unbindService(this.A02);
            }
        } catch (Exception e8) {
            A07(C01887l.A1n, new C01897m(e8));
        }
    }
}
