...
public class NC extends Button {
    ...
    public NC(C0823Wy c0823Wy, C1K c1k) {
        super(c0823Wy);
        this.A03 = false;
        this.A01 = 0;
        this.A00 = 0;
        this.A04 = true;
        this.A05 = false;
        this.A08 = new C0697Ry(this);
        this.A09 = new C0696Rx(this);
        this.A02 = c1k;
        this.A07 = ID.A04(c0823Wy);
        this.A06 = ID.A00(c0823Wy);
    ...
    private void A04() {
        ...
        this.A03 = true;
        if (ID.A1z(getContext()) && Build.VERSION.SDK_INT >= 16) {
