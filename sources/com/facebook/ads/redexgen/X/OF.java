...
public enum OF {
    ...
    A0E(A01(351, 24, 96)),
    A03(A01(244, 13, 76)),
    A06(A01(281, 18, R.styleable.AppCompatTheme_textColorSearchUrl)),
    A05(A01(262, 19, 19)),
    A0D(A01(341, 10, 39)),
    A0F(A01(375, 3, 12)),
    A04(A01(257, 5, 2)),
    A09(A01(304, 6, 81)),
    A0H(A01(388, 10, 14)),
    A0M(A01(457, 15, R.styleable.AppCompatTheme_windowMinWidthMinor)),
    A07(A01(299, 5, 1)),
    A0G(A01(378, 10, 20)),
    A0C(A01(331, 10, 83)),
    A0N(A01(472, 10, 4)),
    A0K(A01(418, 10, 38)),
    A0J(A01(407, 11, 121)),
    A0P(A01(482, 12, R.styleable.AppCompatTheme_textAppearanceSearchResultTitle)),
    A0L(A01(446, 11, 11)),
    A0B(A01(320, 11, 93)),
    A08(A01(428, 18, 20)),
    A0I(A01(398, 9, 16)),
    A0O(A01(0, 0, R.styleable.AppCompatTheme_toolbarStyle));
    ...
    public static OF A00(String str) {
        for (OF of2 : values()) {
            if (of2.A00.equalsIgnoreCase(str)) {
                return of2;
            }
        }
        return A0O;
