...
public final class HR {
    ...
    */
    public static com.facebook.ads.redexgen.X.HQ A06(byte[] r19, int r20, int r21) {
        /*
            Method dump skipped, instruction units count: 519
            To view this dump change 'Code comments level' option to 'DEBUG'
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.HR.A06(byte[], int, int):com.facebook.ads.redexgen.X.HQ");
    }
    ...
    */
    ...
    public static HP A05(byte[] bArr, int i10, int i11) {
        ...
        hw.A06();
        return new HP(iA04, seqParameterSetId, hw.A0A());
    }
    ...
    */
    ...
    public static boolean A0C(String str, byte b4) {
        if (A07(46, 9, R.styleable.AppCompatTheme_windowFixedWidthMinor).equals(str) && (b4 & 31) == 6) {
            return true;
        }
        return A07(55, 10, 62).equals(str) && ((b4 & 126) >> 1) == 39;
    }
}
