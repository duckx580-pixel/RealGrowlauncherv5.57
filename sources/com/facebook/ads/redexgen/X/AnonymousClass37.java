...
public class AnonymousClass37 {
    ...
    public int A05(View view) {
        if (!A04) {
            try {
                A02 = View.class.getDeclaredField(A01(22, 10, R.styleable.AppCompatTheme_windowFixedWidthMajor));
    ...
    public void A0B(View view) {
        if (view instanceof InterfaceC00742p) {
            ((InterfaceC00742p) view).stopNestedScroll();
        }
    }
    ...
    public final void A0E(View view, @Nullable C00712m c00712m) {
        view.setAccessibilityDelegate(c00712m == null ? null : c00712m.A00());
    }

    public void A0F(View view, InterfaceC00772s interfaceC00772s) {
    }
