...
public class C01395e {
    ...
    public C01395e(String str, String str2, @Nullable String str3, boolean z3, @Nullable String str4) {
        this.A03 = str;
        this.A02 = str2;
        this.A01 = str3;
        this.A04 = z3;
    ...
    public static C01395e A00(JSONObject jSONObject) throws JSONException {
        return new C01395e(jSONObject.getString(A01(30, 3, 81)), jSONObject.getString(A01(26, 4, R.styleable.AppCompatTheme_textColorSearchUrl)), jSONObject.optString(A01(5, 9, 70)), jSONObject.getString(A01(14, 8, R.styleable.AppCompatTheme_textColorSearchUrl)).equals(A01(22, 4, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle)), jSONObject.optString(A01(0, 5, 91)));
    }
}
