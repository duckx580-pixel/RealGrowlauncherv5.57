...
public final class C2D {
    ...
    static {
        A06();
        A03 = new String[]{A02(452, 7, 20), A02(459, 19, R.styleable.AppCompatTheme_textColorSearchUrl), A02(478, 25, 96), A02(503, 15, 30), A02(613, 9, 99), A02(622, 21, 8), A02(643, 27, 68), A02(670, 17, 53), A02(540, 21, 23), A02(418, 16, 83), A02(434, 18, 91), A02(398, 20, 78), A02(696, 20, R.styleable.AppCompatTheme_windowFixedWidthMajor), A02(352, 14, 46), A02(561, 25, R.styleable.AppCompatTheme_windowActionBarOverlay)};
    }
    ...
    private String A03(String str, String str2) {
        String strA7a = this.A00.A7a(str, str2);
        if (strA7a == null) {
            return str2;
        }
        String value = A02(586, 4, 39);
        return strA7a.equals(value) ? str2 : strA7a;
    }
    ...
    public static Map<String, String> A05(@Nullable String str) {
        ...
        try {
            ...
            if (A04(jSONObject.getString(A02(670, 17, 53))).size() == 0) {
                A08(C01887l.A27, new C01897m(A02(239, 20, R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle)));
                return null;
            }
            if (A04(jSONObject.getString(A02(503, 15, 30))).size() == 0) {
                A08(C01887l.A24, new C01897m(A02(221, 18, 10)));
                return null;
            }
            return map;
        } catch (JSONException e8) {
            A08(C01887l.A26, new C01897m(e8));
            return null;
        }
    }

    private final void A07() {
        C2I c2iA56 = this.A00.A56();
        c2iA56.ADL(A02(518, 22, R.styleable.AppCompatTheme_windowNoTitle), 0L);
        c2iA56.A3N();
    }

    public static void A08(int i10, C01897m c01897m) {
        C0822Wx sdkContext = C7F.A00();
        if (sdkContext != null) {
            sdkContext.A06().A8u(A02(687, 9, 5), i10, c01897m);
        }
    }

    public final long A09() {
        return this.A00.A6s(A02(518, 22, R.styleable.AppCompatTheme_windowNoTitle), 0L);
    }
    ...
    public final C2H A0A() {
        ...
        try {
            ...
            A07();
            A08(C01887l.A25, new C01897m(e8));
        }
        return c2h;
    }
    ...
    public final C2H A0B() {
        ...
        try {
            ...
            A07();
            A08(C01887l.A28, new C01897m(e8));
        }
        return c2h;
    }
    ...
    public final String A0G() {
        return A03(A02(459, 19, R.styleable.AppCompatTheme_textColorSearchUrl), A02(268, 23, 59));
    }
    ...
    public final String A0I() {
        return A03(A02(561, 25, R.styleable.AppCompatTheme_windowActionBarOverlay), A02(0, 0, 94));
    }
    ...
    public final String A0M() {
        return A03(A02(696, 20, R.styleable.AppCompatTheme_windowFixedWidthMajor), A02(291, 21, 17));
    }
    ...
    public final void A0N(@Nullable String str) {
        ...
        C2I c2iA56 = this.A00.A56();
        for (String str2 : A03) {
            c2iA56.ADM(str2, mapA05.get(str2));
        }
        c2iA56.ADL(A02(518, 22, R.styleable.AppCompatTheme_windowNoTitle), System.currentTimeMillis());
        c2iA56.A3N();
    }

    public final boolean A0O(Context context, boolean z3) {
        return (z3 || ID.A1x(context)) && ((A09() > 0L ? 1 : (A09() == 0L ? 0 : -1)) > 0);
    }
}
