...
@TargetApi(19)
public final class C0701Sd implements InterfaceC0521Ld {
    ...
    public final IT A08;
    public final C0547Me A09;
    public final C0548Mf A0A;
    public final SD A0B;
    public final AnonymousClass57 A06 = new C0704Sg(this);
    ...
    static {
        A04();
        A0E = C0701Sd.class.getSimpleName();
    }

    public C0701Sd(AnonymousClass59 anonymousClass59, C0823Wy c0823Wy, IT it, InterfaceC0520Lc interfaceC0520Lc) {
        SD sd2;
        this.A07 = anonymousClass59;
        this.A08 = it;
        int i10 = (int) (Kd.A02 * 2.0f);
        C0703Sf c0703Sf = new C0703Sf(this, interfaceC0520Lc);
        if (c0823Wy.A0C() == null) {
            c0823Wy.A0D().A86();
        }
        if (IE.A02(c0823Wy) || c0823Wy.A0C() == null) {
            sd2 = new SD(c0823Wy, c0703Sf);
        } else {
            sd2 = new SD(c0823Wy, c0823Wy.A0C(), c0703Sf);
        }
        this.A0B = sd2;
        this.A09 = new C0547Me(c0823Wy, this.A0B);
        C0547Me c0547Me = this.A09;
        int progressBarHeightPx = View.generateViewId();
        c0547Me.setId(progressBarHeightPx);
        RelativeLayout.LayoutParams controlsViewParams = new RelativeLayout.LayoutParams(-1, -2);
        controlsViewParams.addRule(10);
        this.A09.setListener(new C0702Se(this, anonymousClass59));
        interfaceC0520Lc.A3I(this.A09, controlsViewParams);
        ...
        interfaceC0520Lc.A3I(this.A0B, layoutParams);
        this.A0A = new C0548Mf(c0823Wy, null, R.attr.progressBarStyleHorizontal);
        ...
        interfaceC0520Lc.A3I(this.A0A, controlsViewParams2);
    ...
    public final void A8k(Intent intent, Bundle bundle, AnonymousClass59 anonymousClass59) {
        ...
        String strA032 = A03(220, 11, com.rtsoft.growtopia.R.styleable.AppCompatTheme_windowMinWidthMinor);
        String strA033 = A03(210, 10, com.rtsoft.growtopia.R.styleable.AppCompatTheme_textColorSearchUrl);
        if (bundle == null) {
    ...
    public final void ABd(boolean z3) {
        ...
        if (this.A04) {
            this.A04 = false;
            C0551Mi c0551MiA07 = new C0550Mh(this.A0B.getFirstUrl()).A01(this.A00).A03(this.A01).A04(this.A0B.getResponseEndMs()).A00(this.A0B.getDomContentLoadedMs()).A05(this.A0B.getScrollReadyMs()).A02(this.A0B.getLoadFinishMs()).A06(System.currentTimeMillis()).A07();
            this.A08.A8p(this.A03, c0551MiA07.A02());
            if (BuildConfigApi.isDebug()) {
                String str = A03(169, 30, 38) + System.currentTimeMillis() + A03(149, 20, 20) + c0551MiA07.A01 + A03(53, 22, 86) + c0551MiA07.A03 + A03(75, 24, 83) + c0551MiA07.A04 + A03(0, 30, 42) + c0551MiA07.A00 + A03(99, 24, 127) + c0551MiA07.A05 + A03(30, 23, com.rtsoft.growtopia.R.styleable.AppCompatTheme_windowFixedHeightMajor) + c0551MiA07.A02 + A03(123, 26, 72) + c0551MiA07.A06;
            }
        }
    }
    ...
    public final void AEB(Bundle bundle) {
        bundle.putString(A03(210, 10, com.rtsoft.growtopia.R.styleable.AppCompatTheme_textColorSearchUrl), this.A02);
    }
