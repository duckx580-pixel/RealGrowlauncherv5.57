...
public class C00983o {
    ...
    public C00983o(int i10, int i11, int i12, Object obj) {
        this.A00 = i10;
        this.A02 = i11;
        this.A01 = i12;
        this.A03 = obj;
    ...
    private final String A00() {
        ...
        if (i10 == 4) {
            return A01(19, 2, R.styleable.AppCompatTheme_tooltipFrameBackground);
        }
        if (i10 == 8) {
            return A01(15, 2, R.styleable.AppCompatTheme_windowFixedHeightMajor);
        }
        String[] strArr = A05;
    ...
    public final boolean equals(Object obj) {
        ...
        C00983o c00983o = (C00983o) obj;
        int i10 = this.A00;
        if (i10 != c00983o.A00) {
            return false;
        }
        if (i10 == 8 && Math.abs(this.A01 - this.A02) == 1 && this.A01 == c00983o.A02 && this.A02 == c00983o.A01) {
            return true;
        }
        if (this.A01 != c00983o.A01 || this.A02 != c00983o.A02) {
            return false;
        }
        Object obj2 = this.A03;
        if (obj2 != null) {
            if (!obj2.equals(c00983o.A03)) {
                return false;
            }
        } else {
            Object obj3 = c00983o.A03;
            if (A05[2].charAt(7) == 'q') {
                throw new RuntimeException();
            }
