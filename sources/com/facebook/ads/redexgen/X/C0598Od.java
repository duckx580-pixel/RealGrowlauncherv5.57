...
public final class C0598Od {
    ...
    @Nullable
    public static BitmapDrawable A00(C0823Wy c0823Wy, @Nullable String str) {
        try {
            ...
            if (overlayBm != null && (!A00 || A05(c0823Wy, overlayBm))) {
                ...
                if (resources != null) {
                    ...
                    if (displayMetrics != null) {
                        ...
                        A04(c0823Wy, A02(0, 23, R.styleable.AppCompatTheme_windowFixedWidthMajor));
                    }
                } else {
                    A04(c0823Wy, A02(23, 18, R.styleable.AppCompatTheme_windowActionBarOverlay));
                }
                return overlayRepeat;
            }
            return null;
        } catch (Throwable th2) {
            c0823Wy.A06().A8u(A02(59, 3, 42), C01887l.A1t, new C01897m(th2));
            return null;
        }
    }

    @Nullable
    public static C0599Oe A01(C0823Wy c0823Wy, @Nullable String str) {
        BitmapDrawable bitmapDrawableA00;
        try {
            if (TextUtils.isEmpty(str) || (bitmapDrawableA00 = A00(c0823Wy, str)) == null) {
                return null;
            }
            C0599Oe overlayView = new C0599Oe(c0823Wy);
    ...
    public static void A04(C0823Wy c0823Wy, String str) {
        c0823Wy.A06().A8u(A02(59, 3, 42), C01887l.A1t, new C01897m(str));
    }
    ...
    */
    public static boolean A05(com.facebook.ads.redexgen.X.C0823Wy r5, android.graphics.Bitmap r6) {
        /*
            r3 = 0
        L1:
            int r4 = r6.getWidth()
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C0598Od.A02
            r0 = 2
            r1 = r1[r0]
            r0 = 4
            ...
            if (r1 == r0) goto L4d
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C0598Od.A02
        ...
        L4d:
            ...
            throw r0
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0598Od.A05(com.facebook.ads.redexgen.X.Wy, android.graphics.Bitmap):boolean");
    }
}
