...
public final class C0529Ll extends RelativeLayout {
    ...
    public C0529Ll(C0823Wy c0823Wy, int i10, int i11, String str, @Nullable String str2, String str3, String str4, Bitmap bitmap) {
        super(c0823Wy);
        this.A05 = new TextView(c0823Wy);
        this.A02 = new Button(c0823Wy);
        this.A01 = new Button(c0823Wy);
        this.A03 = new ImageView(c0823Wy);
        this.A04 = new LinearLayout(c0823Wy);
        ...
        LE.A0O(button4, iA01, negativeButtonColor2);
        A00();
        setGravity(17);
    }
