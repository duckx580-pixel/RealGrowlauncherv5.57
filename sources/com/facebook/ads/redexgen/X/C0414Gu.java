...
public class C0414Gu implements Comparable<C0414Gu> {
    ...
    public C0414Gu(String str, long j, long j10, long j11, @Nullable File file) {
        this.A04 = str;
        this.A02 = j;
        this.A01 = j10;
        this.A05 = file != null;
    ...
    public final int compareTo(@NonNull C0414Gu c0414Gu) {
        if (!this.A04.equals(c0414Gu.A04)) {
            return this.A04.compareTo(c0414Gu.A04);
        }
        long j = this.A02 - c0414Gu.A02;
        String[] strArr = A06;
