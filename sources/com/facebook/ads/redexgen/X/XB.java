...
public final class XB implements InterfaceC01425h {
    public static byte[] A02;
    public static final String A03;
    public final InterfaceC01455k A00;
    ...
    static {
        A02();
        A03 = XB.class.getSimpleName();
    }

    public XB(InterfaceC01455k interfaceC01455k, C0822Wx c0822Wx) {
        this.A00 = interfaceC01455k;
        this.A00.A3D(new XD(this));
        this.A01 = new C6G(c0822Wx);
        A01();
    }
    ...
    public void A01() {
        if (BuildConfigApi.isDebug()) {
            String.format(Locale.US, A00(0, 20, R.styleable.AppCompatTheme_windowFixedHeightMajor), Integer.valueOf(this.A00.A5h().size()));
        }
        for (InterfaceC01485n asset : this.A00.A5h()) {
            int i10 = C01445j.A00[asset.A7h().ordinal()];
            if (i10 == 1) {
                A04(asset.getUrl());
            } else if (i10 == 2) {
                A06(asset.getUrl());
        ...
        this.A01.A0W(new XC(this), new AnonymousClass69(A00(81, 36, 11), A00(125, 7, 46)));
    }
    ...
    private void A04(String str) {
        ...
        c6e.A01 = A00(R.styleable.AppCompatTheme_windowFixedWidthMinor, 8, 90);
        this.A01.A0b(c6e);
    }
    ...
    private void A05(String str) {
        ...
        c6c.A04 = true;
        c6c.A02 = A00(R.styleable.AppCompatTheme_windowFixedWidthMinor, 8, 90);
        this.A01.A0X(c6c);
    }
