...
public final class CR {
    ...
    public static CQ A04(HV hv) throws C9R {
        ...
        int iA0A3 = hv.A0A();
        int iA0E2 = hv.A0E();
        return new CQ(jA0K, iA0E, jA0K2, iA0A, iA0A2, iA0A3, (int) Math.pow(2.0d, iA0E2 & 15), (int) Math.pow(2.0d, (iA0E2 & 240) >> 4), (hv.A0E() & 1) > 0, Arrays.copyOf(hv.A00, hv.A07()));
    }
    ...
    public static long A01(long j, long j10) {
    ...
    /* JADX WARN: Code restructure failed: missing block: B:44:0x00ea, code lost:
        ...
        return new com.facebook.ads.redexgen.X.CN(r9, r10, r11, r12, r13);
     */
    ...
    /* JADX WARN: Code restructure failed: missing block: B:51:0x0114, code lost:
        ...
        throw new com.facebook.ads.redexgen.X.C9R(A05(228, 42, 126) + r12);
     */
    ...
    */
    public static com.facebook.ads.redexgen.X.CN A02(com.facebook.ads.redexgen.X.CL r14) throws com.facebook.ads.redexgen.X.C9R {
        /*
    ...
    public static CO A03(HV hv) throws C9R {
        ...
        while (true) {
            ...
            if (j < jA0K) {
                ...
                int length6 = hv.A0E();
                if ((length6 & 1) != 0) {
                    return new CO(strA0S, strArr, i11 + 1);
                }
    ...
    public static void A07(int i10, CL cl2) throws C9R {
        int j;
        int iA02 = cl2.A02(6) + 1;
        for (int i11 = 0; i11 < iA02; i11++) {
            int iA022 = cl2.A02(16);
            if (iA022 != 0) {
                ...
                if (cl2.A04()) {
                    ...
                    for (int i14 = 0; i14 < i13; i14++) {
                        ...
                        cl2.A03(A00(mappingsCount));
                        int mappingsCount2 = i10 - 1;
                        cl2.A03(A00(mappingsCount2));
                    }
                }
                int mappingsCount3 = cl2.A02(2);
                if (mappingsCount3 == 0) {
                    if (j > 1) {
                    ...
                    throw new C9R(A05(406, 58, 29));
                }
            }
        }
    }

    public static void A08(CL cl2) throws C9R {
        int iA02 = cl2.A02(6) + 1;
        for (int j = 0; j < iA02; j++) {
            ...
            if (iA022 == 0) {
                ...
                if (iA022 != 1) {
                    throw new C9R(A05(R.styleable.AppCompatTheme_windowFixedHeightMajor, 41, 34) + iA022);
                }
                int j10 = cl2.A02(5);
                int i11 = -1;
                int[] classDimensions = new int[j10];
                for (int floorCount3 = 0; floorCount3 < j10; floorCount3++) {
                    classDimensions[floorCount3] = cl2.A02(4);
    ...
    public static void A09(CL cl2) throws C9R {
        int iA02 = cl2.A02(6) + 1;
        for (int i10 = 0; i10 < iA02; i10++) {
            int residueCount = cl2.A02(16);
            if (residueCount <= 2) {
                cl2.A03(24);
                cl2.A03(24);
                cl2.A03(24);
                int iA022 = cl2.A02(6) + 1;
                cl2.A03(8);
                int[] iArr = new int[iA022];
                for (int i11 = 0; i11 < iA022; i11++) {
                    int iA023 = 0;
                    int residueCount2 = cl2.A02(3);
                    if (cl2.A04()) {
                        iA023 = cl2.A02(5);
                    }
                ...
                throw new C9R(A05(363, 43, 2));
            }
        }
    }

    public static boolean A0A(int i10, HV hv, boolean z3) throws C9R {
        if (hv.A04() < 7) {
            if (z3) {
                return false;
            }
            throw new C9R(A05(464, 18, 36) + hv.A04());
        }
        if (hv.A0E() != i10) {
            if (z3) {
                return false;
            }
            throw new C9R(A05(93, 21, 41) + Integer.toHexString(i10));
        }
        if (hv.A0E() != 118 || hv.A0E() != 111 || hv.A0E() != 114 || hv.A0E() != 98 || hv.A0E() != 105 || hv.A0E() != 115) {
            if (z3) {
                return false;
            }
            throw new C9R(A05(10, 28, 123));
        }
        return true;
    }

    public static CP[] A0B(CL cl2) {
        int iA02 = cl2.A02(6) + 1;
        CP[] cpArr = new CP[iA02];
        for (int windowType = 0; windowType < iA02; windowType++) {
            boolean zA04 = cl2.A04();
            int iA022 = cl2.A02(16);
            int i10 = cl2.A02(16);
            cpArr[windowType] = new CP(zA04, iA022, i10, cl2.A02(8));
        }
        return cpArr;
    }
