...
public enum EnumC0500Ki {
    ...
    EnumC0500Ki(int i10, NativeAdBase.NativeComponentTag nativeComponentTag) {
        this.A00 = i10;
        this.A01 = nativeComponentTag;
    }

    public static EnumC0500Ki A00(NativeAdBase.NativeComponentTag nativeComponentTag) {
        for (EnumC0500Ki enumC0500Ki : values()) {
            if (enumC0500Ki.A01 == nativeComponentTag) {
                return enumC0500Ki;
            }
        }
        return null;
    ...
    public static void A03(View view, NativeAdBase.NativeComponentTag nativeComponentTag) {
        EnumC0500Ki internalTag = A00(nativeComponentTag);
        if (view != null && internalTag != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, nativeComponentTag);
        }
    }

    public static void A04(View view, EnumC0500Ki enumC0500Ki) {
        if (view != null && enumC0500Ki != null && Build.VERSION.SDK_INT > 4) {
            view.setTag(A02, enumC0500Ki);
        }
    }
