...
public final class C00270t {
     ...
     */
    public final synchronized void A0A(String str) throws JSONException, C01897m {
        if (str != null) {
            if (!str.trim().isEmpty()) {
    ...
    private final synchronized C1O A00(String str, JSONObject jSONObject) throws JSONException, C01897m {
        C1O frequencyCappingData;
        if (str.equals(jSONObject.optString(A01(29, 12, R.styleable.AppCompatTheme_windowFixedWidthMajor), null))) {
            frequencyCappingData = new C1O(str);
            A03(frequencyCappingData, jSONObject);
        } else {
            C01897m c01897m = new C01897m(new IllegalArgumentException());
    ...
    private void A03(C1O c1o, JSONObject jSONObject) throws JSONException {
        ...
        int iOptInt2 = jSONObject.optInt(A01(R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle, 11, 91));
        ...
        c1o.A05(iOptInt, iOptInt2, jOptLong, maxCappedArrayLength);
    }
    ...
    public final synchronized void A0B(JSONObject jSONObject) throws JSONException {
        C1O frequencyCappingData;
        String strOptString = jSONObject.optString(A01(29, 12, R.styleable.AppCompatTheme_windowFixedWidthMajor), null);
        if (strOptString == null) {
            return;
        }
        if (this.A00.has(strOptString) && (this.A00.get(strOptString) instanceof C1O)) {
            frequencyCappingData = (C1O) this.A00.get(strOptString);
        } else {
            frequencyCappingData = new C1O(strOptString);
        }
        A03(frequencyCappingData, jSONObject);
