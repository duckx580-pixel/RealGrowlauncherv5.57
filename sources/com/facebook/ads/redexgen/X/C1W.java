...
public final class C1W implements Serializable {
    ...
    public static String A03(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            ...
            bArrCopyOfRange[i13] = (byte) (i14 ^ R.styleable.AppCompatTheme_windowMinWidthMajor);
        }
    ...
    public C1W(String str, String str2, int i10, String str3, String str4, N3 n32, int i11, boolean z3, boolean z10, C1X c1x, boolean z11, String str5) {
        if (z11) {
            this.A08 = UUID.randomUUID().toString();
            Uri uri = KM.A00(str).buildUpon().appendQueryParameter(A03(132, 11, R.styleable.AppCompatTheme_windowActionBar), this.A08).appendQueryParameter(A03(58, 12, 69), str5).build();
    ...
    public static int A00(JSONObject jSONObject) {
        ...
        return jSONObject.optInt(A03(263, 19, R.styleable.AppCompatTheme_textAppearanceSearchResultTitle), 0);
    }
    ...
    public static C1W A01(JSONObject jSONObject) {
        ...
        C1X precachingMethod = C1X.A00(jSONObjectOptJSONObject.optString(A03(211, 17, 50), A0F.name()));
        return new C1W(jSONObjectOptJSONObject.optString(A03(282, 3, 72)), jSONObjectOptJSONObject.optString(A03(143, 19, 61)), A00(jSONObject), A05(jSONObjectOptJSONObject), A04(jSONObjectOptJSONObject), A02(jSONObjectOptJSONObject), jSONObjectOptJSONObject.optInt(A03(285, 32, 0), 5000), jSONObjectOptJSONObject.optBoolean(A03(R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu, 17, 87), true), jSONObjectOptJSONObject.optBoolean(A03(88, 15, 37)), precachingMethod, jSONObjectOptJSONObject.optBoolean(A03(162, 25, R.styleable.AppCompatTheme_windowActionBar)), jSONObject.optString(A03(70, 2, 71)));
    }
    ...
    public static String A04(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A03(R.styleable.AppCompatTheme_windowNoTitle, 12, 5));
    ...
    public static String A05(JSONObject jSONObject) {
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A03(R.styleable.AppCompatTheme_windowNoTitle, 12, 5));
        String strA03 = A03(45, 13, R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle);
