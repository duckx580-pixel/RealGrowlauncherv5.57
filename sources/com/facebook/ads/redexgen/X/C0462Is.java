...
public final class C0462Is implements NativeAdRatingApi {
    ...
    public C0462Is(double d10, double d11) {
        this.A01 = d10;
        this.A00 = d11;
    }

    @Nullable
    public static C0462Is A00(@Nullable JSONObject jSONObject) {
        if (jSONObject == null) {
            return null;
        }
        if (A03[1].length() == 15) {
            ...
            if (dOptDouble != 0.0d) {
                if (A03[5].charAt(0) == 'R') {
                    ...
                    if (dOptDouble2 != 0.0d) {
                        return new C0462Is(dOptDouble, dOptDouble2);
                    }
                }
            }
            return null;
