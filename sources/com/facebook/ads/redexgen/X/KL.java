...
public final class KL {
    ...
    public static Intent A00(Uri uri) {
        Intent intent = new Intent(A03(R.styleable.AppCompatTheme_windowMinWidthMajor, 26, 123), uri);
    ...
    @VisibleForTesting
    public static Intent A01(C0823Wy c0823Wy, Uri uri) {
        Intent intentA00 = A00(uri);
        intentA00.addCategory(A03(144, 33, 39));
        intentA00.addFlags(268435456);
        intentA00.putExtra(A03(206, 34, 41), c0823Wy.getPackageName());
    ...
    public static Intent A02(C0823Wy c0823Wy, Uri uri) {
        Intent intentA00 = A00(uri);
        intentA00.setPackage(A03(240, 19, 50));
        intentA00.putExtra(A03(187, 8, 74), c0823Wy.getPackageName());
        intentA00.putExtra(A03(354, 7, 31), true);
        return intentA00;
    }

    private void A05(C0823Wy c0823Wy, Uri uri) throws K7 {
        K9.A0B(c0823Wy, A01(c0823Wy, uri));
    }

    private final void A06(C0823Wy c0823Wy, Uri uri) throws K7, KJ {
        if (A0C(c0823Wy)) {
            if (ID.A1m(c0823Wy)) {
                Intent intent = A02(c0823Wy, uri);
                if (K9.A0C(c0823Wy, intent)) {
                    return;
                }
            }
            Intent intentA01 = A01(c0823Wy, uri);
            intentA01.setPackage(A03(240, 19, 50));
            K9.A0B(c0823Wy, intentA01);
            return;
        }
        throw new KJ();
    }

    private void A07(C0823Wy c0823Wy, Uri uri, String str) {
        AdActivityIntent adActivityIntentA04 = K9.A04(c0823Wy);
        adActivityIntentA04.addFlags(268435456);
        adActivityIntentA04.putExtra(A03(376, 8, 90), EnumC0472Jc.A02);
        ...
        try {
            K9.A09(c0823Wy, adActivityIntentA04);
        } catch (K7 e8) {
            ...
            c0823Wy.A06().A8u(A03(R.styleable.AppCompatTheme_toolbarStyle, 11, 73), C01887l.A0D, new C01897m(cause2));
            Log.e(A03(90, 17, R.styleable.AppCompatTheme_windowActionBar), A03(0, 90, 82), cause2);
        }
    }

    private final void A08(C0823Wy c0823Wy, Uri uri, String str) throws K7 {
        boolean zA05 = IE.A05(c0823Wy);
        boolean isInAppBrowserEnabled = A0B(uri);
        if (isInAppBrowserEnabled && zA05) {
            A07(c0823Wy, uri, str);
        } else {
            c0823Wy.A0D().A87(zA05);
            A05(c0823Wy, uri);
        }
    }

    public static void A09(KL kl, C0823Wy c0823Wy, Uri uri, String str) {
        kl.A0D(c0823Wy, uri, str);
    }
    ...
    */
    public static void A0A(com.facebook.ads.redexgen.X.KL r5, com.facebook.ads.redexgen.X.C0823Wy r6, android.net.Uri r7, java.lang.String r8) throws com.facebook.ads.redexgen.X.K7 {
        /*
            boolean r0 = A0B(r7)
            if (r0 == 0) goto L31
        ...
        L31:
            ...
            goto L1b
        L33:
            r5.A06(r6, r7)     // Catch: com.facebook.ads.redexgen.X.KJ -> L37
            goto L3e
        L37:
            r5.A08(r6, r7, r8)
            goto L3e
        ...
        L3e:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.KL.A0A(com.facebook.ads.redexgen.X.KL, com.facebook.ads.redexgen.X.Wy, android.net.Uri, java.lang.String):void");
    }
    ...
    */
    ...
    private boolean A0C(C0823Wy c0823Wy) {
        Intent playStoreIntent = new Intent(A03(R.styleable.AppCompatTheme_windowMinWidthMajor, 26, 123), KM.A00(A03(309, 34, 58)));
        Iterator<ResolveInfo> it = c0823Wy.getPackageManager().queryIntentActivities(playStoreIntent, 0).iterator();
        while (it.hasNext()) {
    ...
    private final boolean A0D(C0823Wy c0823Wy, Uri uri, String str) {
        return K9.A0E(c0823Wy, uri, str);
    }

    public static boolean A0E(KL kl, C0823Wy c0823Wy, Uri uri, String str) {
        try {
            A0A(kl, c0823Wy, uri, str);
            return true;
        } catch (K7 e8) {
            Throwable cause = e8.getCause();
            K7 cause2 = e8;
            ...
            c0823Wy.A06().A8u(A03(R.styleable.AppCompatTheme_toolbarStyle, 11, 73), C01887l.A05, new C01897m(cause2));
            return false;
        }
    }
}
