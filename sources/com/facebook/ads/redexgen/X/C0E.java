...
public final class C0E {
    ...
    public static synchronized void A06(File file) throws IOException {
        if (file.exists()) {
            if (!file.isDirectory()) {
                throw new IOException(A00(R.styleable.AppCompatTheme_tooltipFrameBackground, 5, 68) + file + A00(0, 18, 82));
            }
        } else if (!file.mkdirs()) {
    ...
    public static void A04(File file) throws IOException {
        ...
        RandomAccessFile randomAccessFile = new RandomAccessFile(file, A00(R.styleable.AppCompatTheme_windowFixedHeightMajor, 3, 86));
        long size = length - 1;
    ...
    public static void A05(File file) throws IOException {
        ...
        throw new IOException(A00(47, 30, R.styleable.AppCompatTheme_tooltipForegroundColor) + file);
    }
}
