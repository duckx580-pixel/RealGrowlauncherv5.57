...
public final class KM {
    ...
    public static String A05(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            byte b4 = (byte) ((bArrCopyOfRange[i13] - i12) - 114);
            if (A01[3].length() == 19) {
    ...
    public static Uri A00(String str) {
        ...
        if (c0822WxA00 != null) {
            boolean zA2C = ID.A2C(c0822WxA00);
            if (A01[4].charAt(6) != 'S') {
                throw new RuntimeException();
            }
    ...
    public static void A0B(String str, URI uri, Uri uri2) {
        ...
        String strA05 = A05(0, 0, R.styleable.AppCompatTheme_windowFixedHeightMajor);
        if (!zA0E) {
    ...
    public static void A0C(String str, URI uri, Uri uri2, boolean z3) {
        boolean zA0E = A0E(uri.getScheme(), uri2.getScheme());
    ...
    public static boolean A0D(Uri uri) {
        ...
        return uri.getScheme().matches(A05(0, 26, R.styleable.AppCompatTheme_tooltipFrameBackground));
    }
