...
public final class C1B implements Serializable {
    ...
    public static String A01(int i10, int i11, int i12) {
        ...
        for (int i13 = 0; i13 < bArrCopyOfRange.length; i13++) {
            byte b4 = (byte) ((bArrCopyOfRange[i13] ^ i12) ^ 58);
            String[] strArr = A0B;
    ...
    public static C1B A00(JSONObject jSONObject) {
        int iOptInt;
        C1B c1b = new C1B();
        c1b.A06(new C1H().A0H(jSONObject.optString(A01(405, 5, 2))).A0G(jSONObject.optString(A01(397, 8, 125))).A0B(jSONObject.optString(A01(53, 4, 45))).A0F(jSONObject.optString(A01(383, 14, 15))).A0E(jSONObject.optString(A01(262, 12, R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu))).A0D(jSONObject.optString(A01(250, 12, 99))).A09(jSONObject.optString(A01(37, 16, 47))).A0A(jSONObject.optString(A01(82, 8, 88))).A0C(jSONObject.optString(A01(R.styleable.AppCompatTheme_toolbarNavigationButtonStyle, 17, 9))).A0I());
        c1b.A07(new C1L(jSONObject.optString(A01(162, 12, 14)), jSONObject.optString(A01(68, 14, 78)), jSONObject.optJSONObject(A01(57, 11, 87)), jSONObject.optString(A02(jSONObject))));
        ...
        C1D c1dA0I = new C1D().A0K(jSONObject.optString(A01(496, 9, 21))).A0H(jSONObject.optLong(A01(472, 24, 61), -1L)).A0F(iOptInt).A0E(jSONObject.optInt(A01(274, 18, 10), Integer.MAX_VALUE)).A0I(C1W.A01(jSONObject));
        JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A01(192, 5, 19));
        if (jSONObjectOptJSONObject != null) {
            C1D c1dA0D = c1dA0I.A0J(jSONObjectOptJSONObject.optString(A01(429, 3, R.styleable.AppCompatTheme_textColorAlertDialogListItem))).A0D(jSONObjectOptJSONObject.optInt(A01(505, 5, 29)));
            int unskippableSeconds = A0B[1].length();
            if (unskippableSeconds == 16) {
                A0B[5] = "WsiHjZ6Ab9OhwgLQk07kFOW3FmkdrPnz";
                c1dA0D.A0C(jSONObjectOptJSONObject.optInt(A01(186, 6, 84)));
            }
            throw new RuntimeException();
        }
        c1b.A04(c1dA0I);
        c1b.A0C(jSONObject.optBoolean(A01(325, 21, 121)));
        c1b.A08(new C1M(C0501Kj.A04(jSONObject.optJSONArray(A01(147, 15, 21))), jSONObject.optLong(A01(123, 24, R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu), 0L)));
        c1b.A09(jSONObject.optBoolean(A01(231, 19, 26)));
        return c1b;
    }
    ...
    public static String A02(JSONObject jSONObject) {
        ...
        if (strOptString.equals(strA012)) {
            JSONObject jSONObjectOptJSONObject = jSONObject.optJSONObject(A01(174, 12, R.styleable.AppCompatTheme_windowActionModeOverlay));
            if (jSONObjectOptJSONObject != null) {
    ...
    private final void A0A(boolean z3) {
        this.A07 = z3;
    }

    private final void A0B(boolean z3) {
        this.A08 = z3;
    }
    ...
    public final void A0I(JSONObject jSONObject) {
        ...
        A05(this.A00.A0O());
        A0L(jSONObject.optBoolean(A01(197, 14, R.styleable.AppCompatTheme_windowActionBar)));
    ...
    public final void A0K(JSONObject jSONObject) {
        this.A00.A0G(jSONObject.optInt(A01(454, 18, R.styleable.AppCompatTheme_textColorAlertDialogListItem)));
        this.A00.A0L(jSONObject.optBoolean(A01(211, 20, 76), true));
