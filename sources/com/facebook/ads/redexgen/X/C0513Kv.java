...
public class C0513Kv extends Writer {
    ...
    public C0513Kv(InterfaceC0512Ku interfaceC0512Ku) {
        this.A02 = interfaceC0512Ku;
    }

    private void A00() {
        this.A02.ADE(new String(this.A01, 0, this.A00));
        this.A00 = 0;
    }
    ...
    */
    public final void write(char[] r6, int r7, int r8) throws java.io.IOException {
        ...
        L1:
            int r4 = r7 + r8
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C0513Kv.A03
            r0 = 3
            r1 = r2[r0]
            r0 = 1
            r0 = r2[r0]
        ...
        L40:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0513Kv.write(char[], int, int):void");
    }
}
