...
public enum QP {
    A09(A00(145, 13, 65), QR.A02, true),
    A08(A00(128, 17, 7), QR.A03, true),
    A07(A00(R.styleable.AppCompatTheme_windowFixedHeightMajor, 14, 69), QR.A03, false),
    A0A(A00(171, 23, 11), QR.A03, false),
    A0B(A00(158, 13, 70), QR.A03, true),
    A06(A00(97, 17, R.styleable.AppCompatTheme_viewInflaterClass), QR.A03, false);
    ...
    QP(String str, QR qr, boolean z3) {
        this.A01 = str;
        this.A00 = qr;
        this.A02 = z3;
    }
