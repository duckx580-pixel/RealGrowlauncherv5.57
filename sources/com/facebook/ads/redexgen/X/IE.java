...
public final class IE {
    ...
    public static boolean A02(Context context) {
        return ID.A0P(context).A2M(A00(0, 47, R.styleable.AppCompatTheme_tooltipForegroundColor), true);
    }

    public static boolean A03(Context context) {
        return ID.A0P(context).A2M(A00(47, 47, R.styleable.AppCompatTheme_windowFixedHeightMinor), false);
    }

    public static boolean A04(Context context) {
        return ID.A0P(context).A2M(A00(139, 46, R.styleable.AppCompatTheme_windowFixedHeightMajor), false);
    }

    public static boolean A05(Context context) {
        return Build.VERSION.SDK_INT >= 19 && ID.A0P(context).A2M(A00(185, 15, 91), false);
    }

    public static boolean A06(Context context) {
        return ID.A0P(context).A2M(A00(94, 45, 96), false);
    }
}
