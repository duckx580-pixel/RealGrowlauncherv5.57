...
public final class C0577Ni extends RelativeLayout {
    public final View A00;
    public final NJ A01;

    public C0577Ni(C0823Wy c0823Wy, View view) {
        super(c0823Wy);
        this.A00 = view;
        this.A01 = new NJ(c0823Wy);
        LE.A0K(this.A01);
    }
     ...
     */
    public final void A01(@Nullable NO no, boolean z3) {
        ...
        if (no != null) {
            if (z3) {
                ...
                no.setAlignment(3);
                layoutParams2.setMargins(NT.A07 / 2, NT.A07 / 2, NT.A07 / 2, NT.A07 / 2);
                ...
                insideLayoutParams.setMargins(0, NT.A07, 0, 0);
                no.setAlignment(17);
