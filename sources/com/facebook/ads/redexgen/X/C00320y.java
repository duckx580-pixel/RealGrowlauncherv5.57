...
public final class C00320y extends BroadcastReceiver {
    ...
    public C00320y(C0823Wy c0823Wy, String str, ZQ zq, InterfaceC00310x interfaceC00310x) {
        this.A02 = c0823Wy;
        this.A03 = str;
        this.A01 = interfaceC00310x;
        this.A00 = zq;
    }
    ...
    public final void A02() {
        ...
        intentFilter.addAction(A00(135, 38, R.styleable.AppCompatTheme_windowFixedWidthMinor) + this.A03);
    ...
    public final void onReceive(Context context, Intent intent) {
        ...
        String intentAction = A00(0, 1, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle);
        ...
        if (intentAction5.equals(str)) {
            InterfaceC00310x interfaceC00310x = this.A01;
            ZQ zq = this.A00;
            String[] parts3 = A05;
            if (parts3[3].charAt(4) != 'D') {
                A05[0] = "TqpNublq1V6zWfVafs4QLB";
                interfaceC00310x.AAx(zq);
                return;
            } else {
        ...
        if (intentAction9.equals(str)) {
            InterfaceC00310x interfaceC00310x2 = this.A01;
            String[] strArr = A05;
        ...
        InterfaceC00310x interfaceC00310x3 = this.A01;
        String[] parts4 = A05;
        if (parts4[7].charAt(0) != 'P') {
            throw new RuntimeException();
        }
        A05[0] = "2dNMpRkIvORsTqY7tSIXPx";
        interfaceC00310x3.AB2();
    }
}
