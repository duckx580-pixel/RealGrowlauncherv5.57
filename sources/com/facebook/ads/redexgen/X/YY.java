...
public final class YY implements InterfaceC00571x {
    ...
    static {
        A0B();
        A0D = YY.class.getSimpleName();
    }

    public YY(AnonymousClass20 anonymousClass20, AnonymousClass27 anonymousClass27, String str) {
        this.A0A = anonymousClass20;
        this.A08 = anonymousClass20.A05();
        this.A09 = new YP(str, anonymousClass27, this);
    }
    ...
    public final void A0H(AdCompanionView adCompanionView) {
        ...
        this.A04 = (C0833Xi) adCompanionView.getAdCompanionViewApi();
        C0823Wy c0823Wy = this.A08;
        if (c0823Wy != null && (anonymousClass18 = this.A02) != null) {
            this.A04.A03(c0823Wy, anonymousClass18);
        }
    }
    ...
    public final void A0I(@Nullable EnumSet<CacheFlag> enumSet, @Nullable String str) {
        ...
        if (this.A06 && !ID.A0g(this.A08)) {
            this.A08.A06().A8u(A0A(130, 3, 62), C01887l.A0L, new C01897m(A0A(78, 52, 69)));
        ...
        EC ec2 = this.A03;
        if (ec2 != null) {
            ec2.A0M(new C0853Yd(this));
            this.A03.A0H();
            this.A03 = null;
        }
        C00491p c00491p = new C00491p(this.A0A.A09(), JA.A00(this.A08.getResources().getDisplayMetrics()), AdPlacementType.INTERSTITIAL, J6.A07, 1, enumSet);
        if (ID.A1w(this.A08) && (strA02 = KN.A02(this.A08, this.A0A.A07())) != null) {
        ...
        c00491p.A06(this.A0A.A07());
        c00491p.A07(this.A0A.A08());
        c00491p.A04(this.A0A.A03());
        this.A03 = new EC(this.A08, c00491p);
        this.A03.A0M(new C0850Ya(this));
        this.A03.A0P(str);
    }
    ...
    public final boolean A0L() {
        ...
        EC ec2 = this.A03;
        if (ec2 == null) {
            this.A08.A06().A8u(A0A(130, 3, 62), C01887l.A0S, new C01897m(AdErrorType.INTERSTITIAL_CONTROLLER_IS_NULL.getDefaultErrorMessage()));
            this.A08.A0D().A2a(L5.A01(this.A00), adError.getErrorCode(), adError.getErrorMessage());
            this.A09.onError(this.A0A.A01(), adError);
            return false;
        }
