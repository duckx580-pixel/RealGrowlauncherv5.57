...
public final class C0445Ib {
    ...
    public C0445Ib(String str, IT it) {
        this.A01 = str;
        this.A00 = it;
    }

    public final void A02(EnumC0444Ia enumC0444Ia, @Nullable Map<String, String> data) {
        A03(enumC0444Ia.A02(), data);
    }

    public final void A03(String str, @Nullable Map<String, String> map) {
        if (!C0447Id.A0B(this.A01, str)) {
            return;
        }
        if (map == null) {
            map = new HashMap<>();
