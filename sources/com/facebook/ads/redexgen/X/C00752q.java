...
public final class C00752q {
    public static String[] A05 = {"efs8eZdEWHsCfUb6qOzicmMnQm4SneBY", "GPD1kjm6fR3i7blABsL8PkfqVt5tQ0ec", "1ZMAOqgxiysbgCK2QhJ8YR6mzQdOOVTU", "tADzoHnDRwqyF4JfOWpRm", PredefinedUICustomizationFont.defaultFamily, "2dCxtsKJi8key4A0", "YZUwpVg0T4azRRaUQd2X9mlkfrI9cQeh", "C6BrW2LKkOXM7XSn"};
    ...
    public C00752q(@NonNull View view) {
        this.A04 = view;
    }
    ...
    public final void A03(int i10) {
        ...
        if (viewParentA00 != null) {
            C3O.A02(viewParentA00, this.A04, i10);
            A01(i10, null);
        }
    }
    ...
    public final boolean A07(float f9, float f10) {
        ...
        return C3O.A06(viewParentA00, this.A04, f9, f10);
    }

    public final boolean A08(float f9, float f10, boolean z3) {
        ViewParent viewParentA00;
        if (!A06() || (viewParentA00 = A00(0)) == null) {
            return false;
        }
        return C3O.A07(viewParentA00, this.A04, f9, f10, z3);
    }
    ...
    public final boolean A0D(int i10, int i11, int i12, int i13, @Nullable int[] iArr, int startX) {
        ...
        if (i10 != 0 || i11 != 0 || i12 != 0 || i13 != 0) {
            ...
            C3O.A03(viewParentA00, this.A04, i10, i11, i12, i13, startX);
            if (iArr != null) {
                this.A04.getLocationInWindow(iArr);
                iArr[0] = iArr[0] - i14;
                iArr[1] = iArr[1] - i15;
    ...
    */
    public final boolean A0F(int r17, int r18, @androidx.annotation.Nullable int[] r19, @androidx.annotation.Nullable int[] r20, int r21) {
        ...
        L20:
            r7 = 0
            r6 = 0
            java.lang.String[] r1 = com.facebook.ads.redexgen.X.C00752q.A05
            r0 = 3
            r0 = r1[r0]
            int r1 = r0.length()
            r0 = 9
            if (r1 == r0) goto L9b
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C00752q.A05
        ...
        La7:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C00752q.A0F(int, int, int[], int[], int):boolean");
    }
}
