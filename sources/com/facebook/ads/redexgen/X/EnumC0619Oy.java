...
public enum EnumC0619Oy {
    A06(R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle),
    A09(R.styleable.AppCompatTheme_textAppearanceSearchResultTitle),
    A0A(R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu),
    A07(R.styleable.AppCompatTheme_textColorAlertDialogListItem),
    A08(R.styleable.AppCompatTheme_textColorSearchUrl),
    A05(R.styleable.AppCompatTheme_toolbarNavigationButtonStyle),
    A04(R.styleable.AppCompatTheme_toolbarStyle),
    A03(R.styleable.AppCompatTheme_tooltipForegroundColor);
