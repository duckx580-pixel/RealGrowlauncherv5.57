...
public final class C0523Lf extends View {
    public int A00;
    public Paint A01;
    public Paint A02;
    public Paint A03;
    ...
    public C0523Lf(C0823Wy c0823Wy) {
        this(c0823Wy, 60, true);
    }

    public C0523Lf(C0823Wy c0823Wy, int i10, boolean z3) {
        super(c0823Wy);
        this.A00 = i10;
        this.A04 = z3;
        if (z3) {
    ...
    public RelativeLayout.LayoutParams getDefaultLayoutParams() {
        ...
        int i10 = this.A00;
        float density = i10;
        int i11 = (int) (density * f9);
        float density2 = i10;
        RelativeLayout.LayoutParams layoutParams = new RelativeLayout.LayoutParams(i11, (int) (density2 * f9));
