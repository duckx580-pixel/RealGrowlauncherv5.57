...
public class C0632Pl implements MediaController.MediaPlayerControl {
    ...
    public C0632Pl(TextureViewSurfaceTextureListenerC0419Gz textureViewSurfaceTextureListenerC0419Gz) {
    ...
    public final boolean isPlaying() {
        if (this.A00.A06 != null) {
            TextureViewSurfaceTextureListenerC0419Gz textureViewSurfaceTextureListenerC0419Gz = this.A00;
            if (A01[3].length() == 27) {
                throw new RuntimeException();
            }
            A01[1] = "lkPRs4KbLtabABAzVL2ijXaoS745wM0q";
            if (textureViewSurfaceTextureListenerC0419Gz.A06.isPlaying()) {
                return true;
            }
        }
        return false;
