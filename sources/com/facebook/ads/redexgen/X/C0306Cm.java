...
public final class C0306Cm {
    ...
    public C0306Cm(String str, @Nullable String str2, @Nullable MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z3, boolean z10, boolean z11) {
        this.A02 = (String) H6.A01(str);
        this.A01 = str2;
        this.A00 = codecCapabilities;
        this.A04 = z3;
        boolean z12 = true;
        this.A03 = (z10 || codecCapabilities == null || !A07(codecCapabilities)) ? false : true;
        this.A06 = codecCapabilities != null && A0B(codecCapabilities);
        if (!z11 && (codecCapabilities == null || !A09(codecCapabilities))) {
            z12 = false;
        }
        this.A05 = z12;
    }
    ...
    public static int A00(String str, String str2, int i10) {
        int i11;
        if (i10 > 1 || ((C0431Hl.A02 >= 26 && i10 > 0) || A03(226, 10, 45).equals(str2) || A03(121, 10, 96).equals(str2) || A03(140, 12, 97).equals(str2) || A03(211, 15, 35).equals(str2) || A03(255, 12, 77).equals(str2) || A03(236, 10, 92).equals(str2) || A03(246, 9, R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle).equals(str2) || A03(162, 10, R.styleable.AppCompatTheme_toolbarNavigationButtonStyle).equals(str2) || A03(172, 15, 62).equals(str2) || A03(187, 15, 13).equals(str2) || A03(202, 9, 74).equals(str2))) {
            return i10;
        }
        ...
        Log.w(A03(54, 14, R.styleable.AppCompatTheme_windowActionBar), A03(9, 29, 122) + str + A03(6, 3, 52) + i10 + A03(0, 4, 49) + i11 + A03(79, 1, R.styleable.AppCompatTheme_windowMinWidthMinor));
        return i11;
    }

    public static C0306Cm A01(String str) {
        return new C0306Cm(str, null, null, true, false, false);
    }

    public static C0306Cm A02(String str, String str2, MediaCodecInfo.CodecCapabilities codecCapabilities, boolean z3, boolean z10) {
        return new C0306Cm(str, str2, codecCapabilities, false, z3, z10);
    }
    ...
    private void A05(String str) {
        ...
        sb2.append(strA03);
        sb2.append(this.A02);
        sb2.append(A03(4, 2, R.styleable.AppCompatTheme_windowNoTitle));
        sb2.append(this.A01);
        sb2.append(strA03);
        sb2.append(C0431Hl.A04);
        sb2.append(A03(79, 1, R.styleable.AppCompatTheme_windowMinWidthMinor));
        sb2.toString();
    }
    ...
    public static boolean A07(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0431Hl.A02 >= 19 && A08(codecCapabilities);
    }
    ...
    public static boolean A09(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0431Hl.A02 >= 21 && A0A(codecCapabilities);
    }
    ...
    public static boolean A0B(MediaCodecInfo.CodecCapabilities codecCapabilities) {
        return C0431Hl.A02 >= 21 && A0C(codecCapabilities);
    }
    ...
    public final Point A0E(int i10, int i11) {
        ...
        if (videoCapabilities == null) {
            A06(A03(R.styleable.AppCompatTheme_viewInflaterClass, 11, 7));
            return null;
        }
        int widthAlignment = videoCapabilities.getWidthAlignment();
        int heightAlignment = videoCapabilities.getHeightAlignment();
        int heightAlignment2 = C0431Hl.A04(i10, widthAlignment);
        return new Point(heightAlignment2 * widthAlignment, C0431Hl.A04(i11, heightAlignment) * heightAlignment);
    }
    ...
    public final boolean A0G(int i10) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            String strA03 = A03(371, 15, R.styleable.AppCompatTheme_toolbarStyle);
            String[] strArr = A08;
    ...
    public final boolean A0H(int i10, int i11, double d10) {
        MediaCodecInfo.CodecCapabilities codecCapabilities = this.A00;
        if (codecCapabilities == null) {
            A06(A03(421, 16, R.styleable.AppCompatTheme_textAppearanceSearchResultSubtitle));
            return false;
        }
        MediaCodecInfo.VideoCapabilities videoCapabilities = codecCapabilities.getVideoCapabilities();
        if (videoCapabilities == null) {
    ...
    public final boolean A0I(String str) {
        ...
        if (A08[4].charAt(25) != 'Z') {
            ...
            String strA03 = A03(4, 2, R.styleable.AppCompatTheme_windowNoTitle);
            ...
            if (codecMimeType.charAt(14) != 'p') {
                ...
                Pair<Integer, Integer> pairA02 = C0317Cx.A02(str);
                if (pairA02 == null) {
                    return true;
                }
