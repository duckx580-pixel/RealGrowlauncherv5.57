...
public final class HK implements PQ {
    ...
    private ValueAnimator A00(View view, int i10, int i11) {
        ...
        valueAnimatorOfInt.addUpdateListener(new PZ(this, view));
    ...
    public void A08(boolean z3) {
        if (z3) {
            ...
            this.A00.addListener(new PY(this));
            this.A00.start();
            return;
        }
    ...
    public void A09(boolean z3) {
        ...
        if (z3) {
            ...
            this.A00.addListener(new PX(this));
            this.A00.start();
            return;
        }
        View view = this.A05;
