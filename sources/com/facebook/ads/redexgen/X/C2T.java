    ...
    */
    ...
    public final boolean A07(Intent intent) {
        ...
        synchronized (this.A04) {
            ...
            HashMap<String, ArrayList<C2S>> map = this.A03;
            String type4 = intent.getAction();
            ArrayList<C2S> arrayList = map.get(type4);
            if (arrayList != null) {
                if (z3) {
                ...
                while (i10 < arrayList.size()) {
                    ...
                    if (z3) {
                        ...
                        String type6 = A01(R.styleable.AppCompatTheme_textColorAlertDialogListItem, 24, 48);
                        sb4.append(type6);
                        sb4.append(c2s.A03);
                        sb4.toString();
                    }
                    if (!c2s.A00) {
                        ...
                        String type7 = strResolveTypeIfNeeded;
                        int iMatch = c2s.A03.match(action, type7, scheme2, data, categories, A01(83, 21, 127));
                        if (iMatch >= 0) {
                            if (z3) {
                                String str2 = A01(24, 27, 33) + Integer.toHexString(iMatch);
                            }
                            if (arrayList2 == null) {
