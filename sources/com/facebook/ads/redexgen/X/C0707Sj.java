...
public final class C0707Sj implements LK {
    ...
    */
    public static void A00(int[] r42, int r43, int r44, int r45, int r46, int r47, int r48) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0707Sj.A00(int[], int, int, int, int, int, int):void");
    }
    ...
    public final Bitmap A02(Bitmap bitmap, float f9) {
        ...
        try {
            int[] iArr = new int[w * h10];
            bitmap.getPixels(iArr, 0, w, 0, 0, w, h10);
            int i10 = LP.A00;
            ...
            for (int i11 = 0; i11 < i10; i11++) {
                int h11 = h10;
                int cores = i11;
                arrayList.add(new LO(iArr, w, h11, (int) f9, i10, cores, 1));
                h10 = h11;
                int cores2 = i11;
                vertical.add(new LO(iArr, w, h10, (int) f9, i10, cores2, 2));
            }
            try {
                ...
                try {
                    ...
                    try {
                        return Bitmap.createBitmap(iArr, w, h10, Bitmap.Config.ARGB_8888);
