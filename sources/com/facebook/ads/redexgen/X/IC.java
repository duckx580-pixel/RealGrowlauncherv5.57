...
public final class IC {
    ...
    public static long A00(Context context) {
        return ID.A0P(context).A2I(A02(29, 25, 4), -1L);
    }

    public static long A01(Context context) {
        return ID.A0P(context).A2I(A02(131, 31, 5), -1L);
    }

    public static boolean A04(Context context) {
        return ID.A0P(context).A2M(A02(54, 39, 15), true);
    }

    public static boolean A05(Context context) {
        return ID.A0P(context).A2M(A02(0, 29, 11), false);
    }

    public static boolean A06(Context context) {
        return ID.A0P(context).A2M(A02(93, 16, 92), false);
    }

    public static boolean A07(Context context) {
        return ID.A0P(context).A2M(A02(R.styleable.AppCompatTheme_tooltipFrameBackground, 22, 1), false);
    }
}
