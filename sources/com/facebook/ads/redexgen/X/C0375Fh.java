...
public final class C0375Fh {
    ...
    public List<C0375Fh> A00;
    public final long A01;
    public final long A02;
    public final C0381Fn A03;
     ...
     */
    private void A08(long j, Map<String, C0381Fn> map, Map<String, SpannableStringBuilder> map2) {
        if (A0C(j)) {
    ...
    java.lang.ArrayIndexOutOfBoundsException: Index 26 out of bounds for length 23
    	...
    	at jadx.core.dex.visitors.debuginfo.DebugInfoAttachVisitor.visit(DebugInfoAttachVisitor.java:38)
     */
    public final List<FJ> A0D(long j, Map<String, C0381Fn> map, Map<String, C0376Fi> map2) {
        ...
        while (true) {
            ...
            C0376Fi c0376Fi = map2.get(entry.getKey());
            arrayList.add(new FJ(A01((SpannableStringBuilder) entry.getValue()), (Layout.Alignment) null, c0376Fi.A00, c0376Fi.A05, c0376Fi.A04, c0376Fi.A01, Integer.MIN_VALUE, c0376Fi.A03, c0376Fi.A06, c0376Fi.A02));
        }
    }
    ...
    public C0375Fh(@Nullable String str, String str2, long j, long j10, C0381Fn c0381Fn, String[] strArr, String str3) {
        this.A05 = str;
        this.A06 = str2;
        this.A03 = c0381Fn;
        this.A0A = strArr;
    ...
    */
    private android.text.SpannableStringBuilder A01(android.text.SpannableStringBuilder r9) {
        ...
        L70:
            ...
            if (r0 != r6) goto La8
            int r7 = r5 + 1
            java.lang.String[] r2 = com.facebook.ads.redexgen.X.C0375Fh.A0C
            r0 = 3
            r1 = r2[r0]
            r0 = 6
            r0 = r2[r0]
        ...
        Lba:
            return r9
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0375Fh.A01(android.text.SpannableStringBuilder):android.text.SpannableStringBuilder");
    }
    ...
    private final C0375Fh A03(int i10) {
        List<C0375Fh> list = this.A00;
        if (list != null) {
            return list.get(i10);
        }
    ...
    public static C0375Fh A04(String str) {
        return new C0375Fh(null, C0377Fj.A02(str), -9223372036854775807L, -9223372036854775807L, null, null, A06(0, 0, 53));
    }

    public static C0375Fh A05(String str, long j, long j10, C0381Fn c0381Fn, String[] strArr, String str2) {
        return new C0375Fh(str, null, j, j10, c0381Fn, strArr, str2);
    }

    private void A09(long j, boolean z3, String str, Map<String, SpannableStringBuilder> regionOutputs) {
        String str2 = str;
        this.A09.clear();
        this.A08.clear();
        if (A06(2, 8, R.styleable.AppCompatTheme_tooltipForegroundColor).equals(this.A05)) {
            return;
        }
        ...
        String resolvedRegionId2 = A06(0, 2, R.styleable.AppCompatTheme_textAppearanceSmallPopupMenu);
        if (resolvedRegionId2.equals(str3) && z3) {
        ...
        boolean zEquals = resolvedRegionId3.equals(str4);
        for (int i10 = 0; i10 < A00(); i10++) {
            A03(i10).A09(j, z3 || zEquals, str2, regionOutputs);
        }
        if (zEquals) {
            C0377Fj.A04(A02(str2, regionOutputs));
        }
    ...
    private void A0A(Map<String, C0381Fn> map, SpannableStringBuilder spannableStringBuilder, int i10, int i11) {
        C0381Fn resolvedStyle = C0377Fj.A00(this.A03, this.A0A, map);
        if (resolvedStyle != null) {
            C0377Fj.A05(spannableStringBuilder, i10, i11, resolvedStyle);
        }
    }

    private void A0B(TreeSet<Long> out, boolean z3) {
        ...
        while (true) {
            ...
            if (i10 < list.size()) {
                C0375Fh c0375Fh = this.A00.get(i10);
                boolean isPNode = z3 || zEquals;
                c0375Fh.A0B(out, isPNode);
                i10++;
            } else {
                return;
            }
    ...
    public final void A0E(C0375Fh c0375Fh) {
        if (this.A00 == null) {
            this.A00 = new ArrayList();
        }
        this.A00.add(c0375Fh);
    }
