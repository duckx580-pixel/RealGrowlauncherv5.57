...
public abstract class AbstractC0890Zp implements C0B {
        ...
        for (File file : list) {
            ...
            if (!A08(file, jA02, size)) {
                ...
                if (file.delete()) {
                    size--;
                    jA02 -= length;
                    Log.i(A03, A03(61, 11, 10) + file + A03(19, 42, R.styleable.AppCompatTheme_windowNoTitle));
                } else {
    ...
    public abstract boolean A08(File file, long j, int i10);

    static {
        A04();
        A03 = AbstractC0890Zp.class.getSimpleName();
    }
    ...
    public void AF2(final File file) throws IOException {
