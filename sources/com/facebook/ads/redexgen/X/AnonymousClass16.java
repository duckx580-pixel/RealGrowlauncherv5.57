        ...
        if (str3.equals(action5)) {
            ...
            if (serializableExtra instanceof C0484Jq) {
                ...
                if (this.A02) {
                    ...
                    this.A01.A0Y(((C0484Jq) serializableExtra).A01());
                }
                this.A01.setVisibility(0);
                this.A01.A0b(P3.A04, 1);
                return;
            }
            if (serializableExtra instanceof LC) {
                ...
                InterfaceC0528Lk listener = this.A01.getListener();
                String[] split2 = A04;
            ...
            if (serializableExtra instanceof C0502Kk) {
                if (this.A01.getListener() != null) {
                    InterfaceC0528Lk listener2 = this.A01.getListener();
                    String[] split3 = A04;
            ...
            if (!(serializableExtra instanceof C01746s) || this.A01.getListener() == null) {
                return;
            }
