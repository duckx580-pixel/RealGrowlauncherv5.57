...
public final class C0737Tn implements H0 {
    ...
    public static final C0737Tn A04;
    public int A00;
    ...
    static {
        A03();
        A04 = new C0737Tn(Collections.emptyMap());
    }

    public C0737Tn(Map<String, byte[]> metadata) {
        this.A01 = Collections.unmodifiableMap(metadata);
    }

    public static C0737Tn A00(DataInputStream dataInputStream) throws IOException {
    ...
    */
    public static void A04(java.util.HashMap<java.lang.String, byte[]> r2, java.util.List<java.lang.String> r3) {
        ...
        L11:
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: com.facebook.ads.redexgen.X.C0737Tn.A04(java.util.HashMap, java.util.List):void");
    }
    ...
    public final C0737Tn A08(H2 h22) {
        Map<String, byte[]> mapA02 = A02(this.A01, h22);
        if (A06(mapA02)) {
            return this;
        }
        return new C0737Tn(mapA02);
    }
