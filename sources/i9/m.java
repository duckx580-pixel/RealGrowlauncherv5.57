...
public abstract class m {
    ...
    public static final int[] f8167a = {R.attr.colorPrimary};

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final int[] f8168b = {R.attr.colorPrimaryVariant};

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final p f8169c = new p(6);
    ...
    public static void a(Context context, AttributeSet attributeSet, int i10, int i11) {
        ...
        if (z3) {
            ...
            if (!context.getTheme().resolveAttribute(R.attr.isMaterialTheme, typedValue, true) || (typedValue.type == 18 && typedValue.data == 0)) {
                c(context, f8168b, "Theme.MaterialComponents");
            }
        }
        c(context, f8167a, "Theme.AppCompat");
    }
