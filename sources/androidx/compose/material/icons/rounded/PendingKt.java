...
public final class PendingKt {
    ...
    public static final f getPending(c cVar) {
        l.f("<this>", cVar);
        f fVar = _pending;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Pending", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.h(8.5f, 12.83f, 7.83f, 13.5f, 7.0f, 13.5f);
        nVarA.g();
        nVarA.n(12.0f, 13.5f);
        nVarA.i(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        nVarA.i(0.0f, -0.83f, 0.67f, -1.5f, 1.5f, -1.5f);
        nVarA.q(1.5f, 0.67f, 1.5f, 1.5f);
        nVarA.h(13.5f, 12.83f, 12.83f, 13.5f, 12.0f, 13.5f);
        nVarA.g();
        nVarA.n(17.0f, 13.5f);
        nVarA.i(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        nVarA.i(0.0f, -0.83f, 0.67f, -1.5f, 1.5f, -1.5f);
        nVarA.q(1.5f, 0.67f, 1.5f, 1.5f);
        nVarA.h(18.5f, 12.83f, 17.83f, 13.5f, 17.0f, 13.5f);
        nVarA.g();
