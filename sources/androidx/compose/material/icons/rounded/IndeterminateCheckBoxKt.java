...
public final class IndeterminateCheckBoxKt {
    ...
    public static final f getIndeterminateCheckBox(c cVar) {
        l.f("<this>", cVar);
        f fVar = _indeterminateCheckBox;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.IndeterminateCheckBox", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarC.l(21.0f, 5.0f);
        nVarC.i(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.n(nVarC, 16.0f, 13.0f, 8.0f, 13.0f);
