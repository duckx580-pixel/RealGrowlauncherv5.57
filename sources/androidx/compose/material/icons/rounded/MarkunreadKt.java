...
public final class MarkunreadKt {
    ...
    public static final f getMarkunread(c cVar) {
        l.f("<this>", cVar);
        f fVar = _markunread;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Markunread", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarC.l(22.0f, 6.0f);
        nVarC.i(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        k0.c.g(nVarC, 19.6f, 8.25f, -6.54f, 4.09f);
        nVarC.i(-0.65f, 0.41f, -1.47f, 0.41f, -2.12f, 0.0f);
        nVarC.l(4.4f, 8.25f);
