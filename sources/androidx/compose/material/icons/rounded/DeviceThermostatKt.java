...
public final class DeviceThermostatKt {
    ...
    public static final f getDeviceThermostat(c cVar) {
        l.f("<this>", cVar);
        f fVar = _deviceThermostat;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.DeviceThermostat", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.c.a(15.0f, 13.0f, 5.0f);
