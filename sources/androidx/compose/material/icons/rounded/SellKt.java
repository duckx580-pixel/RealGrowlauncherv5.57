...
public final class SellKt {
    ...
    public static final f getSell(c cVar) {
        l.f("<this>", cVar);
        f fVar = _sell;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Sell", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.g();
        nVarB.n(6.5f, 8.0f);
        nVarB.h(5.67f, 8.0f, 5.0f, 7.33f, 5.0f, 6.5f);
        nVarB.p(5.67f, 5.0f, 6.5f, 5.0f);
        nVarB.p(8.0f, 5.67f, 8.0f, 6.5f);
        nVarB.p(7.33f, 8.0f, 6.5f, 8.0f);
        nVarB.g();
