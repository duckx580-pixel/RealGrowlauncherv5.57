...
public final class AssignmentTurnedInKt {
    ...
    public static final f getAssignmentTurnedIn(c cVar) {
        l.f("<this>", cVar);
        f fVar = _assignmentTurnedIn;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.AssignmentTurnedIn", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.q(0.45f, -1.0f, 1.0f, -1.0f);
        a.n(nVarB, 9.29f, 16.29f, 6.7f, 13.7f);
        ...
        nVarB.i(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        nVarB.m(-6.59f, 6.59f);
        nVarB.i(-0.38f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        nVarB.g();
