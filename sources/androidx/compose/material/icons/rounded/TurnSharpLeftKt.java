...
public final class TurnSharpLeftKt {
    ...
    public static final f getTurnSharpLeft(c cVar) {
        l.f("<this>", cVar);
        f fVar = _turnSharpLeft;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.TurnSharpLeft", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = gb.e.b(8.0f, 6.83f, 0.88f, 0.88f);
