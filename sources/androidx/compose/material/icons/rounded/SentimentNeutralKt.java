...
public final class SentimentNeutralKt {
    private static f _sentimentNeutral;

    public static final f getSentimentNeutral(c cVar) {
        l.f("<this>", cVar);
        f fVar = _sentimentNeutral;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SentimentNeutral", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(9.75f, 15.5f));
        arrayList.add(new k1.t(4.5f));
        arrayList.add(new s(0.41f, 0.0f, 0.75f, -0.34f, 0.75f, -0.75f));
        arrayList.add(new x(-0.34f, -0.75f, -0.75f, -0.75f));
        arrayList.add(new k1.t(-4.5f));
        arrayList.add(new s(-0.41f, 0.0f, -0.75f, 0.34f, -0.75f, 0.75f));
        arrayList.add(new x(0.34f, 0.75f, 0.75f, 0.75f));
        ...
        arrayList2.add(new n(15.5f, 9.5f));
        ...
        arrayList3.add(new n(8.5f, 9.5f));
