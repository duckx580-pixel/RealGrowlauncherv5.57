...
public final class ExploreKt {
    ...
    public static final f getExplore(c cVar) {
        l.f("<this>", cVar);
        f fVar = _explore;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Explore", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(12.0f, 10.9f);
        ...
        a.n(nVarA, 14.19f, 14.19f, 6.0f, 18.0f);
        nVarA.m(3.81f, -8.19f);
        k0.c.h(nVarA, 18.0f, 6.0f, -3.81f, 8.19f);
