...
public final class FeaturedPlayListKt {
    ...
    public static final f getFeaturedPlayList(c cVar) {
        l.f("<this>", cVar);
        f fVar = _featuredPlayList;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.FeaturedPlayList", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
