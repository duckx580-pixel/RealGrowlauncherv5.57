...
public final class InfoKt {
    ...
    public static final f getInfo(c cVar) {
        l.f("<this>", cVar);
        f fVar = _info;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Info", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.t(4.0f);
        nVarA.i(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        a.t(nVarA, 13.0f, 9.0f, -2.0f);
        a.y(nVarA, 11.0f, 7.0f, 2.0f, 2.0f);
