...
public final class ExitToAppKt {
    ...
    public static final f getExitToApp(c cVar) {
        l.f("<this>", cVar);
        f fVar = _exitToApp;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.ExitToApp", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(10.79f, 16.29f);
