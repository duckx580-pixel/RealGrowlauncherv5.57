...
public final class PermPhoneMsgKt {
    private static f _permPhoneMsg;

    public static final f getPermPhoneMsg(c cVar) {
        l.f("<this>", cVar);
        f fVar = _permPhoneMsg;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PermPhoneMsg", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = a.b(20.0f, 3.0f, -7.0f);
        nVarB.i(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        k0.f.C(nVarB, 9.0f, 3.0f, -3.0f, 5.0f);
        nVarB.i(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        nVarB.l(21.0f, 4.0f);
        nVarB.i(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        k0.c.g(nVarB, 19.23f, 15.26f, -2.54f, -0.29f);
