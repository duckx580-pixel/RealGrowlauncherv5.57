...
public final class EventKt {
    ...
    public static final f getEvent(c cVar) {
        l.f("<this>", cVar);
        f fVar = _event;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Event", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = a.b(16.0f, 13.0f, -3.0f);
        ...
        nVarB.i(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        gb.e.x(nVarB, 5.0f, 9.0f, 14.0f, 10.0f);
        nVarB.i(0.0f, 0.55f, -0.45f, 1.0f, -1.0f, 1.0f);
        nVarB.g();
