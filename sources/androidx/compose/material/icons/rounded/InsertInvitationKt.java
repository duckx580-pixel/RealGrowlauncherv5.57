...
public final class InsertInvitationKt {
    ...
    public static final f getInsertInvitation(c cVar) {
        l.f("<this>", cVar);
        f fVar = _insertInvitation;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.InsertInvitation", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = a.b(16.0f, 12.0f, -3.0f);
