...
public final class StyleKt {
    ...
    public static final f getStyle(c cVar) {
        l.f("<this>", cVar);
        f fVar = _style;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Style", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarF.q(1.0f, 0.45f, 1.0f, 1.0f);
        nVarF.q(-0.45f, 1.0f, -1.0f, 1.0f);
        nVarF.g();
        nVarF.n(5.88f, 19.75f);
