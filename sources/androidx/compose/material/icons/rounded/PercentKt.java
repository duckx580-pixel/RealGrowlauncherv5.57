...
public final class PercentKt {
    ...
    public static final f getPercent(c cVar) {
        l.f("<this>", cVar);
        f fVar = _percent;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Percent", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
