...
public final class SentimentDissatisfiedKt {
    ...
    public static final f getSentimentDissatisfied(c cVar) {
        l.f("<this>", cVar);
        f fVar = _sentimentDissatisfied;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SentimentDissatisfied", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarA.g();
        nVarA.n(12.0f, 14.0f);
        nVarA.i(-1.9f, 0.0f, -3.63f, 0.97f, -4.65f, 2.58f);
        nVarA.i(-0.22f, 0.35f, -0.11f, 0.81f, 0.24f, 1.03f);
        nVarA.i(0.35f, 0.22f, 0.81f, 0.11f, 1.03f, -0.24f);
        nVarA.i(0.74f, -1.18f, 2.0f, -1.88f, 3.38f, -1.88f);
        nVarA.q(2.64f, 0.7f, 3.38f, 1.88f);
        nVarA.i(0.14f, 0.23f, 0.39f, 0.35f, 0.64f, 0.35f);
        nVarA.i(0.14f, 0.0f, 0.27f, -0.04f, 0.4f, -0.11f);
        nVarA.i(0.35f, -0.22f, 0.46f, -0.68f, 0.24f, -1.03f);
        nVarA.h(15.63f, 14.96f, 13.9f, 14.0f, 12.0f, 14.0f);
        nVarA.g();
