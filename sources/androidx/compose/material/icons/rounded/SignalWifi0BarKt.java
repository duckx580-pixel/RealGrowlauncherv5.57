...
public final class SignalWifi0BarKt {
    private static f _signalWifi0Bar;

    public static final f getSignalWifi0Bar(c cVar) {
        l.f("<this>", cVar);
        f fVar = _signalWifi0Bar;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SignalWifi0Bar", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.c.p(nVarA, 12.0f, 18.17f, 2.92f, 9.07f);
        e.a(eVar, nVarA.f3166a, 0, m0Var);
        f fVarB = eVar.b();
        _signalWifi0Bar = fVarB;
        return fVarB;
    }
}
