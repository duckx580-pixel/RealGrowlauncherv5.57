...
public final class EggKt {
    ...
    public static final f getEgg(c cVar) {
        l.f("<this>", cVar);
        f fVar = _egg;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Egg", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.g();
        nVarA.n(13.0f, 18.0f);
        nVarA.i(-3.0f, 0.0f, -5.0f, -1.99f, -5.0f, -5.0f);
        nVarA.i(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        nVarA.q(1.0f, 0.45f, 1.0f, 1.0f);
        nVarA.i(0.0f, 2.92f, 2.42f, 3.0f, 3.0f, 3.0f);
        nVarA.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        nVarA.p(13.55f, 18.0f, 13.0f, 18.0f);
        nVarA.g();
