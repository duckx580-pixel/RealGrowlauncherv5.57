...
public final class PausePresentationKt {
    ...
    public static final f getPausePresentation(c cVar) {
        l.f("<this>", cVar);
        f fVar = _pausePresentation;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PausePresentation", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
