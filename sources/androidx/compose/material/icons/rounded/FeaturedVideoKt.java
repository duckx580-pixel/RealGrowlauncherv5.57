...
public final class FeaturedVideoKt {
    ...
    public static final f getFeaturedVideo(c cVar) {
        l.f("<this>", cVar);
        f fVar = _featuredVideo;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.FeaturedVideo", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarC.l(23.0f, 5.0f);
        nVarC.i(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.n(nVarC, 11.0f, 12.0f, 4.0f, 12.0f);
