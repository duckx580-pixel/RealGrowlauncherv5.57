...
public final class FirstPageKt {
    ...
    public static final f getFirstPage(c cVar) {
        l.f("<this>", cVar);
        f fVar = _firstPage;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.FirstPage", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(17.7f, 15.89f, 13.82f, 12.0f);
        nVarC.m(3.89f, -3.89f);
        ...
        nVarC.m(4.59f, 4.59f);
        nVarC.i(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        nVarC.i(0.38f, -0.38f, 0.38f, -1.02f, -0.01f, -1.4f);
        nVarC.g();
        nVarC.n(7.0f, 6.0f);
