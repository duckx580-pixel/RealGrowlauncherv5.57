...
public final class CallMissedKt {
    ...
    public static final f getCallMissed(c cVar) {
        l.f("<this>", cVar);
        f fVar = _callMissed;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.CallMissed", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(18.89f, 7.7f, 12.0f, 14.59f);
        nVarC.l(6.41f, 9.0f);
        nVarC.j(10.0f);
        ...
        nVarC.i(-0.38f, -0.38f, -1.02f, -0.38f, -1.4f, 0.0f);
        nVarC.g();
