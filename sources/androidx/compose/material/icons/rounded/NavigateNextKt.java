...
public final class NavigateNextKt {
    ...
    public static final f getNavigateNext(c cVar) {
        l.f("<this>", cVar);
        f fVar = _navigateNext;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.NavigateNext", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(9.31f, 6.71f);
        nVarA.i(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        nVarA.l(13.19f, 12.0f);
        nVarA.m(-3.88f, 3.88f);
        nVarA.i(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
