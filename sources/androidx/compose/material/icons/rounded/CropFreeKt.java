...
public final class CropFreeKt {
    ...
    public static final f getCropFree(c cVar) {
        l.f("<this>", cVar);
        f fVar = _cropFree;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.CropFree", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarL = a.l(3.0f, 5.0f, 3.0f);
        ...
        nVarL.i(0.0f, -0.55f, -0.45f, -1.0f, -1.0f, -1.0f);
        nVarL.q(-1.0f, 0.45f, -1.0f, 1.0f);
        d.i(nVarL, 2.0f, 19.0f, 3.0f, -3.0f);
        nVarL.i(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        nVarL.q(0.45f, 1.0f, 1.0f, 1.0f);
        nVarL.k(2.0f);
        nVarL.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
