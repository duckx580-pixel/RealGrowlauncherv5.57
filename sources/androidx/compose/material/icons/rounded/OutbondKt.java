...
public final class OutbondKt {
    ...
    public static final f getOutbond(c cVar) {
        l.f("<this>", cVar);
        f fVar = _outbond;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Outbond", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
