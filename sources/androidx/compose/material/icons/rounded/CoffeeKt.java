...
public final class CoffeeKt {
    ...
    public static final f getCoffee(c cVar) {
        l.f("<this>", cVar);
        f fVar = _coffee;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Coffee", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarS.i(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        nVarS.t(0.0f);
        nVarS.h(4.0f, 19.45f, 4.45f, 19.0f, 5.0f, 19.0f);
        nVarS.g();
