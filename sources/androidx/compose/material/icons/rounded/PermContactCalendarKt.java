...
public final class PermContactCalendarKt {
    private static f _permContactCalendar;

    public static final f getPermContactCalendar(c cVar) {
        l.f("<this>", cVar);
        f fVar = _permContactCalendar;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PermContactCalendar", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.q(1.34f, -3.0f, 3.0f, -3.0f);
        a.n(nVarB, 18.0f, 18.0f, 6.0f, 18.0f);
        nVarB.t(-1.0f);
