...
public final class HttpsKt {
    private static f _https;

    public static final f getHttps(c cVar) {
        l.f("<this>", cVar);
        f fVar = _https;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Https", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = k0.c.b(18.0f, 8.0f, -1.0f, 17.0f, 6.0f);
