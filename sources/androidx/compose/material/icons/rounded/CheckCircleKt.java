...
public final class CheckCircleKt {
    ...
    public static final f getCheckCircle(c cVar) {
        l.f("<this>", cVar);
        f fVar = _checkCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.CheckCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.n(nVarA, 9.29f, 16.29f, 5.7f, 12.7f);
        ...
        nVarA.i(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        nVarA.m(-7.59f, 7.59f);
        nVarA.i(-0.38f, 0.39f, -1.02f, 0.39f, -1.41f, 0.0f);
        nVarA.g();
