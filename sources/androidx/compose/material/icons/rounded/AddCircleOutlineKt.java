...
public final class AddCircleOutlineKt {
    private static f _addCircleOutline;

    public static final f getAddCircleOutline(c cVar) {
        l.f("<this>", cVar);
        f fVar = _addCircleOutline;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.AddCircleOutline", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
