...
public final class RemoveCircleOutlineKt {
    ...
    public static final f getRemoveCircleOutline(c cVar) {
        l.f("<this>", cVar);
        f fVar = _removeCircleOutline;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.RemoveCircleOutline", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(7.0f, 12.0f);
