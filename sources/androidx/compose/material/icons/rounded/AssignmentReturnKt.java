...
public final class AssignmentReturnKt {
    private static f _assignmentReturn;

    public static final f getAssignmentReturn(c cVar) {
        l.f("<this>", cVar);
        f fVar = _assignmentReturn;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.AssignmentReturn", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.q(0.45f, -1.0f, 1.0f, -1.0f);
        a.u(nVarB, 16.0f, 15.0f, -4.0f, 3.0f);
        nVarB.m(-4.65f, -4.65f);
        nVarB.i(-0.2f, -0.2f, -0.2f, -0.51f, 0.0f, -0.71f);
        gb.e.o(nVarB, 12.0f, 8.0f, 3.0f, 4.0f);
        nVarB.t(4.0f);
        nVarB.g();
        e.a(eVar, nVarB.f3166a, 0, m0Var);
        f fVarB = eVar.b();
        _assignmentReturn = fVarB;
        return fVarB;
    }
}
