...
public final class WhereToVoteKt {
    private static f _whereToVote;

    public static final f getWhereToVote(c cVar) {
        l.f("<this>", cVar);
        f fVar = _whereToVote;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.WhereToVote", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.c.g(nVarA, 10.23f, 12.66f, -1.41f, -1.41f);
        ...
        nVarA.i(0.39f, 0.39f, 0.39f, 1.02f, 0.0f, 1.41f);
        nVarA.m(-3.54f, 3.54f);
        nVarA.h(11.26f, 13.05f, 10.62f, 13.05f, 10.23f, 12.66f);
        nVarA.g();
