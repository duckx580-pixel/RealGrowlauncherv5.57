...
public final class PhoneCallbackKt {
    ...
    public static final f getPhoneCallback(c cVar) {
        l.f("<this>", cVar);
        f fVar = _phoneCallback;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PhoneCallback", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
