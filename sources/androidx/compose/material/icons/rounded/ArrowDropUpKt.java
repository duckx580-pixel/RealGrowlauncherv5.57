...
public final class ArrowDropUpKt {
    ...
    public static final f getArrowDropUp(c cVar) {
        l.f("<this>", cVar);
        f fVar = _arrowDropUp;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.ArrowDropUp", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(8.71f, 12.29f));
        arrayList.add(new m(11.3f, 9.7f));
