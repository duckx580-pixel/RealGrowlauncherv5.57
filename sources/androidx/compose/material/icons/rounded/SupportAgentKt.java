...
public final class SupportAgentKt {
    ...
    public static final f getSupportAgent(c cVar) {
        l.f("<this>", cVar);
        f fVar = _supportAgent;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SupportAgent", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarA.m(0.0f, -4.81f);
        nVarA.i(0.0f, -3.83f, 2.95f, -7.18f, 6.78f, -7.29f);
        nVarA.i(3.96f, -0.12f, 7.22f, 3.06f, 7.22f, 7.0f);
        nVarA.s(19.0f);
        nVarA.k(-7.0f);
        nVarA.i(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        nVarA.t(0.0f);
