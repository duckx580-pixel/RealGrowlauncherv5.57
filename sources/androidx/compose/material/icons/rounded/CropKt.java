...
public final class CropKt {
    ...
    public static final f getCrop(c cVar) {
        l.f("<this>", cVar);
        f fVar = _crop;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Crop", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = k0.c.b(17.0f, 15.0f, 2.0f, 19.0f, 7.0f);
        nVarB.i(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        gb.e.o(nVarB, 9.0f, 5.0f, 2.0f, 7.0f);
        nVarB.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        k0.c.f(nVarB, 7.0f, 8.0f, 17.0f);
        nVarB.i(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        nVarB.l(7.0f, 2.0f);
