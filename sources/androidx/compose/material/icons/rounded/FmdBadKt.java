...
public final class FmdBadKt {
    ...
    public static final f getFmdBad(c cVar) {
        l.f("<this>", cVar);
        f fVar = _fmdBad;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.FmdBad", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.n(nVarA, 12.0f, 15.0f, 12.0f, 15.0f);
        ...
        nVarA.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        nVarA.t(0.0f);
        nVarA.h(13.0f, 14.55f, 12.55f, 15.0f, 12.0f, 15.0f);
        a.n(nVarA, 12.0f, 11.0f, 12.0f, 11.0f);
        nVarA.i(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        nVarA.s(7.0f);
        nVarA.i(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
        nVarA.k(0.0f);
        nVarA.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        nVarA.t(3.0f);
        nVarA.h(13.0f, 10.55f, 12.55f, 11.0f, 12.0f, 11.0f);
        nVarA.g();
