...
public final class WifiLockKt {
    ...
    public static final f getWifiLock(c cVar) {
        l.f("<this>", cVar);
        f fVar = _wifiLock;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.WifiLock", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = a.a(23.21f, 8.24f);
        nVarA.h(20.22f, 5.6f, 16.3f, 4.0f, 12.0f, 4.0f);
        nVarA.p(3.78f, 5.6f, 0.79f, 8.24f);
        ...
        nVarA.m(2.34f, -2.34f);
        nVarA.s(15.0f);
        nVarA.i(0.0f, -0.45f, 0.09f, -0.88f, 0.23f, -1.29f);
        nVarA.i(0.54f, -1.57f, 2.01f, -2.71f, 3.77f, -2.71f);
        nVarA.k(2.94f);
        nVarA.m(1.29f, -1.29f);
