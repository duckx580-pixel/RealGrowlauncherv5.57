...
public final class SwipeLeftAltKt {
    private static f _swipeLeftAlt;

    public static final f getSwipeLeftAlt(c cVar) {
        l.f("<this>", cVar);
        f fVar = _swipeLeftAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SwipeLeftAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(10.1f, 13.0f);
        ...
        nVarA.i(0.39f, 0.39f, 1.02f, 0.39f, 1.41f, 0.0f);
        nVarA.i(0.39f, -0.39f, 0.39f, -1.02f, 0.0f, -1.41f);
        gb.e.l(nVarA, 5.83f, 13.0f, 10.1f);
