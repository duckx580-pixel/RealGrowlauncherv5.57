...
public final class Inventory2Kt {
    ...
    public static final f getInventory2(c cVar) {
        l.f("<this>", cVar);
        f fVar = _inventory2;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Inventory2", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarS.i(0.55f, 0.0f, 1.0f, 0.45f, 1.0f, 1.0f);
        nVarS.t(0.0f);
        nVarS.h(15.0f, 13.55f, 14.55f, 14.0f, 14.0f, 14.0f);
        b.B(nVarS, 20.0f, 7.0f, 4.0f, 4.0f);
        b.g(nVarS, 16.0f, 7.0f);
