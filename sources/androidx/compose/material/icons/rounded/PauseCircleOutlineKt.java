...
public final class PauseCircleOutlineKt {
    ...
    public static final f getPauseCircleOutline(c cVar) {
        l.f("<this>", cVar);
        f fVar = _pauseCircleOutline;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.PauseCircleOutline", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(10.0f, 16.0f);
