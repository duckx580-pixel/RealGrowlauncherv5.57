...
public final class DensityMediumKt {
    private static f _densityMedium;

    public static final f getDensityMedium(c cVar) {
        l.f("<this>", cVar);
        f fVar = _densityMedium;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.DensityMedium", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList3.add(new n(20.0f, 11.0f));
        arrayList3.add(new k1.l(4.0f));
        arrayList3.add(new s(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f));
        arrayList3.add(new s(0.0f, 0.55f, 0.45f, 1.0f, 1.0f, 1.0f));
        arrayList3.add(new k1.t(16.0f));
        arrayList3.add(new s(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f));
        arrayList3.add(new k(21.0f, 11.45f, 20.55f, 11.0f, 20.0f, 11.0f));
        arrayList3.add(jVar);
        e.a(eVar, arrayList3, 0, m0Var3);
        f fVarB = eVar.b();
        _densityMedium = fVarB;
        return fVarB;
    }
}
