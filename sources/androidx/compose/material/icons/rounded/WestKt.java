...
public final class WestKt {
    ...
    public static final f getWest(c cVar) {
        l.f("<this>", cVar);
        f fVar = _west;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.West", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(9.7f, 18.3f, 9.7f, 18.3f);
        ...
        nVarC.i(-0.39f, 0.39f, -0.39f, 1.02f, 0.0f, 1.41f);
        nVarC.m(5.59f, 5.59f);
        nVarC.h(8.68f, 18.68f, 9.32f, 18.68f, 9.7f, 18.3f);
        nVarC.g();
