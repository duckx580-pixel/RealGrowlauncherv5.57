...
public final class HorizontalSplitKt {
    ...
    public static final f getHorizontalSplit(c cVar) {
        l.f("<this>", cVar);
        f fVar = _horizontalSplit;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.HorizontalSplit", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = a.b(4.0f, 19.0f, 16.0f);
