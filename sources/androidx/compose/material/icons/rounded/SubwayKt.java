...
public final class SubwayKt {
    ...
    public static final f getSubway(c cVar) {
        l.f("<this>", cVar);
        f fVar = _subway;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.Subway", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(8.5f, 16.0f));
        ...
        arrayList2.add(new n(15.5f, 16.0f));
        ...
        nVarP.g();
        nVarP.n(18.0f, 15.5f);
        nVarP.i(0.0f, 1.54f, -1.16f, 2.79f, -2.65f, 2.96f);
        nVarP.m(1.15f, 1.16f);
        nVarP.l(16.5f, 20.0f);
        d.n(nVarP, -1.67f, -1.5f, -1.5f, -2.66f);
        nVarP.l(9.17f, 20.0f);
        nVarP.l(7.5f, 20.0f);
        nVarP.t(-0.38f);
        nVarP.m(1.15f, -1.16f);
        nVarP.h(7.16f, 18.29f, 6.0f, 17.04f, 6.0f, 15.5f);
        nVarP.l(6.0f, 9.0f);
        nVarP.i(0.0f, -2.63f, 3.0f, -3.0f, 6.0f, -3.0f);
        nVarP.q(6.0f, 0.37f, 6.0f, 3.0f);
        nVarP.t(6.5f);
        nVarP.g();
