...
public final class LastPageKt {
    ...
    public static final f getLastPage(c cVar) {
        l.f("<this>", cVar);
        f fVar = _lastPage;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.LastPage", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(6.29f, 8.11f, 10.18f, 12.0f);
        nVarC.m(-3.89f, 3.89f);
        ...
        nVarC.l(7.7f, 6.7f);
        nVarC.i(-0.39f, -0.39f, -1.02f, -0.39f, -1.41f, 0.0f);
        nVarC.i(-0.38f, 0.39f, -0.38f, 1.03f, 0.0f, 1.41f);
        nVarC.g();
        nVarC.n(17.0f, 6.0f);
