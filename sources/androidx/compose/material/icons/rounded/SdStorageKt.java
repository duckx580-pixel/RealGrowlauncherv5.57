...
public final class SdStorageKt {
    ...
    public static final f getSdStorage(c cVar) {
        l.f("<this>", cVar);
        f fVar = _sdStorage;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.SdStorage", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = a.b(18.0f, 2.0f, -7.17f);
        nVarB.i(-0.53f, 0.0f, -1.04f, 0.21f, -1.42f, 0.59f);
        nVarB.l(4.6f, 7.42f);
        nVarB.i(-0.37f, 0.37f, -0.6f, 0.88f, -0.6f, 1.4f);
        nVarB.l(4.0f, 20.0f);
