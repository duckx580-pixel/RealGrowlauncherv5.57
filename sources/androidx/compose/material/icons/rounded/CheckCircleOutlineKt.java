...
public final class CheckCircleOutlineKt {
    ...
    public static final f getCheckCircleOutline(c cVar) {
        l.f("<this>", cVar);
        f fVar = _checkCircleOutline;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Rounded.CheckCircleOutline", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.q(-3.59f, 8.0f, -8.0f, 8.0f);
        a.n(nVarA, 15.88f, 8.29f, 10.0f, 14.17f);
        nVarA.m(-1.88f, -1.88f);
