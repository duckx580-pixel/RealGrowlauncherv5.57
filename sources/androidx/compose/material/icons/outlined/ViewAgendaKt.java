...
public final class ViewAgendaKt {
    ...
    public static final f getViewAgenda(b bVar) {
        l.f("<this>", bVar);
        f fVar = _viewAgenda;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ViewAgenda", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        a.C(nVarS, 19.0f, 19.0f, 5.0f, -4.0f);
        ...
        k0.b.B(nVarS2, 19.0f, 9.0f, 5.0f, 5.0f);
        k0.b.g(nVarS2, 14.0f, 9.0f);
