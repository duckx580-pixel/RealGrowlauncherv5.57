...
public final class PanoramaFishEyeKt {
    private static f _panoramaFishEye;

    public static final f getPanoramaFishEye(b bVar) {
        l.f("<this>", bVar);
        f fVar = _panoramaFishEye;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PanoramaFishEye", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
