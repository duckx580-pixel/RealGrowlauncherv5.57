...
public final class PersonPinCircleKt {
    private static f _personPinCircle;

    public static final f getPersonPinCircle(b bVar) {
        l.f("<this>", bVar);
        f fVar = _personPinCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PersonPinCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(12.0f, 11.0f);
        nVarA.i(1.33f, 0.0f, 4.0f, 0.67f, 4.0f, 2.0f);
        nVarA.t(0.16f);
        nVarA.i(-0.97f, 1.12f, -2.4f, 1.84f, -4.0f, 1.84f);
        nVarA.q(-3.03f, -0.72f, -4.0f, -1.84f);
        nVarA.l(8.0f, 13.0f);
        nVarA.i(0.0f, -1.33f, 2.67f, -2.0f, 4.0f, -2.0f);
        nVarA.g();
        nVarA.n(12.0f, 10.0f);
