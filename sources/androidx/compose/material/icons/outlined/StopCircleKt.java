...
public final class StopCircleKt {
    ...
    public static final f getStopCircle(b bVar) {
        l.f("<this>", bVar);
        f fVar = _stopCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.StopCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.p(16.42f, 20.0f, 12.0f, 20.0f);
        k0.b.B(nVarA, 16.0f, 16.0f, 8.0f, 8.0f);
        k0.b.g(nVarA, 8.0f, 16.0f);
