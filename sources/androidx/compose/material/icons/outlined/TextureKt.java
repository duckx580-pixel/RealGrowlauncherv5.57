...
public final class TextureKt {
    ...
    public static final f getTexture(b bVar) {
        l.f("<this>", bVar);
        f fVar = _texture;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Texture", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(19.51f, 3.08f, 3.08f, 19.51f);
        ...
        a.n(nVarC, 11.88f, 3.0f, 3.0f, 11.88f);
        nVarC.t(2.83f);
        nVarC.l(14.71f, 3.0f);
        nVarC.k(-2.83f);
        nVarC.g();
