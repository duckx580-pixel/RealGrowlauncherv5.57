...
public final class MotionPhotosPauseKt {
    ...
    public static final f getMotionPhotosPause(b bVar) {
        l.f("<this>", bVar);
        f fVar = _motionPhotosPause;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.MotionPhotosPause", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.B(nVarB, 11.0f, 15.0f, 9.0f, 9.0f);
