...
public final class AirplayKt {
    ...
    public static final f getAirplay(b bVar) {
        l.f("<this>", bVar);
        f fVar = _airplay;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Airplay", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var2 = new m0(j);
        bj.n nVarS = a.s(21.0f, 3.0f, 3.0f);
        nVarS.h(1.9f, 3.0f, 1.0f, 3.9f, 1.0f, 5.0f);
        nVarS.t(12.0f);
        nVarS.i(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        k0.b.j(nVarS, 4.0f, -2.0f, 3.0f, 5.0f);
        a.w(nVarS, 18.0f, 12.0f, -4.0f, 2.0f);
        nVarS.k(4.0f);
