...
public final class AddBoxKt {
    ...
    public static final f getAddBox(b bVar) {
        l.f("<this>", bVar);
        f fVar = _addBox;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.AddBox", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarC, 11.0f, 17.0f, 2.0f, -4.0f);
        k0.b.v(nVarC, 4.0f, -2.0f, -4.0f);
        gb.e.x(nVarC, 13.0f, 7.0f, -2.0f, 4.0f);
        c.v(nVarC, 7.0f, 11.0f, 2.0f, 4.0f);
