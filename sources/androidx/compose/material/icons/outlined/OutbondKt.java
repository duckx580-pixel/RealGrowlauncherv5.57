...
public final class OutbondKt {
    private static f _outbond;

    public static final f getOutbond(b bVar) {
        l.f("<this>", bVar);
        f fVar = _outbond;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Outbond", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.D(nVarA, 12.0f, 2.0f, 13.88f, 11.54f);
        nVarA.m(-4.96f, 4.96f);
        nVarA.m(-1.41f, -1.41f);
        nVarA.m(4.96f, -4.96f);
        nVarA.l(10.34f, 8.0f);
        nVarA.m(5.65f, 0.01f);
        c.p(nVarA, 16.0f, 13.66f, 13.88f, 11.54f);
