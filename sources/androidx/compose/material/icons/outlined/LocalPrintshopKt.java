...
public final class LocalPrintshopKt {
    ...
    public static final f getLocalPrintshop(b bVar) {
        l.f("<this>", bVar);
        f fVar = _localPrintshop;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.LocalPrintshop", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.n(16.0f, 19.0f);
        gb.e.o(nVarB, 8.0f, 19.0f, -4.0f, 8.0f);
        c.y(nVarB, 4.0f, 18.0f, 15.0f, -2.0f);
        nVarB.l(6.0f, 13.0f);
        d.o(nVarB, 2.0f, 4.0f, 15.0f, -4.0f);
