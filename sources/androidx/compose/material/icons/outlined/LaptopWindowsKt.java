...
public final class LaptopWindowsKt {
    ...
    public static final f getLaptopWindows(b bVar) {
        l.f("<this>", bVar);
        f fVar = _laptopWindows;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.LaptopWindows", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarL = a.l(20.0f, 18.0f, -1.0f);
        ...
        nVarL.t(10.0f);
        nVarL.i(0.0f, 1.1f, 0.9f, 2.0f, 2.0f, 2.0f);
        k0.b.l(nVarL, 1.0f, 0.0f, 2.0f, 24.0f);
        k0.b.o(nVarL, -2.0f, -4.0f, 4.0f, 5.0f);
