...
public final class IndeterminateCheckBoxKt {
    ...
    public static final f getIndeterminateCheckBox(b bVar) {
        l.f("<this>", bVar);
        f fVar = _indeterminateCheckBox;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.IndeterminateCheckBox", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarC, 7.0f, 11.0f, 10.0f, 2.0f);
        nVarC.l(7.0f, 13.0f);
        nVarC.g();
