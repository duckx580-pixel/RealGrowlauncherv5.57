...
public final class CreditScoreKt {
    ...
    public static final f getCreditScore(b bVar) {
        l.f("<this>", bVar);
        f fVar = _creditScore;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.CreditScore", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.r(nVarS, 5.0f, -2.0f, 4.0f, -6.0f);
        nVarS.k(18.0f);
        nVarS.s(6.0f);
        nVarS.h(22.0f, 4.89f, 21.11f, 4.0f, 20.0f, 4.0f);
        k0.b.B(nVarS, 20.0f, 8.0f, 4.0f, 6.0f);
