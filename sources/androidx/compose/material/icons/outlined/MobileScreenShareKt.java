...
public final class MobileScreenShareKt {
    ...
    public static final f getMobileScreenShare(b bVar) {
        l.f("<this>", bVar);
        f fVar = _mobileScreenShare;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.MobileScreenShare", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(17.0f, 1.0f, 7.0f, 1.0f);
        nVarC.i(-1.1f, 0.0f, -1.99f, 0.85f, -1.99f, 1.95f);
        nVarC.t(18.0f);
        nVarC.h(5.01f, 22.05f, 5.9f, 23.0f, 7.0f, 23.0f);
        nVarC.k(10.0f);
        nVarC.i(1.1f, 0.0f, 2.0f, -0.95f, 2.0f, -2.05f);
        nVarC.t(-18.0f);
        nVarC.h(19.0f, 1.85f, 18.1f, 1.0f, 17.0f, 1.0f);
        a.n(nVarC, 17.0f, 19.0f, 7.0f, 19.0f);
        a.y(nVarC, 7.0f, 5.0f, 10.0f, 14.0f);
        nVarC.n(12.8f, 13.24f);
        nVarC.t(1.75f);
        nVarC.l(16.0f, 12.0f);
        nVarC.m(-3.2f, -2.98f);
        nVarC.t(1.7f);
