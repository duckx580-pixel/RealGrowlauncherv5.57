...
public final class ElectricBoltKt {
    ...
    public static final f getElectricBolt(b bVar) {
        l.f("<this>", bVar);
        f fVar = _electricBolt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ElectricBolt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = a.c(14.69f, 2.21f, 4.33f, 11.49f);
