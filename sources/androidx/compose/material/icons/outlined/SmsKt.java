...
public final class SmsKt {
    ...
    public static final f getSms(b bVar) {
        l.f("<this>", bVar);
        f fVar = _sms;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Sms", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.D(nVarC, 7.0f, 11.0f, 15.0f, 9.0f);
        k0.b.t(nVarC, 2.0f, 2.0f, -2.0f);
        a.p(nVarC, 11.0f, 9.0f, 2.0f, 2.0f);
        nVarC.k(-2.0f);
        nVarC.g();
