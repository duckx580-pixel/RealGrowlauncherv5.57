...
public final class AodKt {
    private static f _aod;

    public static final f getAod(b bVar) {
        l.f("<this>", bVar);
        f fVar = _aod;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Aod", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        gb.e.r(nVarC, 10.0f, 4.0f, 8.0f, 10.0f);
        d.y(nVarC, 8.0f, 1.5f, 8.0f, 10.0f);
        a.p(nVarC, 9.0f, 13.0f, 6.0f, 1.5f);
        k0.b.c(nVarC, 9.0f, 13.0f);
