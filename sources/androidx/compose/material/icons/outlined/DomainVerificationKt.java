...
public final class DomainVerificationKt {
    ...
    public static final f getDomainVerification(b bVar) {
        l.f("<this>", bVar);
        f fVar = _domainVerification;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.DomainVerification", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var2 = new m0(j);
        bj.n nVarS = a.s(19.0f, 4.0f, 5.0f);
        ...
        k0.b.B(nVarS, 19.0f, 18.0f, 5.0f, 8.0f);
