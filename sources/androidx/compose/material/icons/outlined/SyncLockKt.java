...
public final class SyncLockKt {
    ...
    public static final f getSyncLock(b bVar) {
        l.f("<this>", bVar);
        f fVar = _syncLock;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.SyncLock", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarL = a.l(10.0f, 4.26f, 2.09f);
        ...
        a.u(nVarL, 20.0f, 4.0f, -6.0f, 6.0f);
        nVarL.k(2.0f);
        nVarL.s(7.56f);
        ...
        a.u(nVarL, 19.0f, 17.0f, -2.0f, -1.0f);
        nVarL.i(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
