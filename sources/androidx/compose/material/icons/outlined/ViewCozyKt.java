...
public final class ViewCozyKt {
    ...
    public static final f getViewCozy(b bVar) {
        l.f("<this>", bVar);
        f fVar = _viewCozy;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ViewCozy", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(7.25f, 7.25f));
        ...
        arrayList2.add(new n(12.75f, 7.25f));
        ...
        arrayList3.add(new n(7.25f, 12.75f));
        ...
        arrayList4.add(new n(12.75f, 12.75f));
