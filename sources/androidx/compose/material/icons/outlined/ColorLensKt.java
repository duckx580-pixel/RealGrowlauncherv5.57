...
public final class ColorLensKt {
    ...
    public static final f getColorLens(b bVar) {
        l.f("<this>", bVar);
        f fVar = _colorLens;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ColorLens", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarA.i(0.0f, -3.86f, -3.59f, -7.0f, -8.0f, -7.0f);
        nVarA.g();
