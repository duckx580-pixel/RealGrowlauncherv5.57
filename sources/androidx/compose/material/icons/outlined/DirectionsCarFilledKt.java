...
public final class DirectionsCarFilledKt {
    private static f _directionsCarFilled;

    public static final f getDirectionsCarFilled(b bVar) {
        l.f("<this>", bVar);
        f fVar = _directionsCarFilled;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.DirectionsCarFilled", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarA.k(-11.0f);
        nVarA.h(5.84f, 5.0f, 5.29f, 5.42f, 5.08f, 6.01f);
        nVarA.l(3.0f, 12.0f);
        nVarA.t(8.0f);
        ...
        nVarA.k(1.0f);
        nVarA.i(0.55f, 0.0f, 1.0f, -0.45f, 1.0f, -1.0f);
        c.o(nVarA, -8.0f, 18.92f, 6.01f);
        nVarA.n(6.85f, 7.0f);
        d.m(nVarA, 10.29f, 1.04f, 3.0f, 5.81f);
        k0.b.D(nVarA, 6.85f, 7.0f, 19.0f, 17.0f);
        k0.e.C(nVarA, 5.0f, -5.0f, 14.0f, 17.0f);
