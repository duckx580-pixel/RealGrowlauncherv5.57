...
public final class TimeToLeaveKt {
    ...
    public static final f getTimeToLeave(b bVar) {
        l.f("<this>", bVar);
        f fVar = _timeToLeave;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.TimeToLeave", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        a.z(nVarA, 1.04f, -3.0f, 19.0f, 16.0f);
        ...
        arrayList.add(new k1.n(7.5f, 13.5f));
        ...
        arrayList2.add(new k1.n(16.5f, 13.5f));
