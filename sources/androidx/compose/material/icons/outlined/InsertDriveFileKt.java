...
public final class InsertDriveFileKt {
    private static f _insertDriveFile;

    public static final f getInsertDriveFile(b bVar) {
        l.f("<this>", bVar);
        f fVar = _insertDriveFile;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.InsertDriveFile", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
