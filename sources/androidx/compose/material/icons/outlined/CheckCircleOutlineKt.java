...
public final class CheckCircleOutlineKt {
    private static f _checkCircleOutline;

    public static final f getCheckCircleOutline(b bVar) {
        l.f("<this>", bVar);
        f fVar = _checkCircleOutline;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.CheckCircleOutline", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.q(-3.59f, 8.0f, -8.0f, 8.0f);
        a.n(nVarA, 16.59f, 7.58f, 10.0f, 14.17f);
        nVarA.m(-2.59f, -2.58f);
        nVarA.l(6.0f, 13.0f);
        a.k(nVarA, 4.0f, 4.0f, 8.0f, -8.0f);
        e.a(eVar, nVarA.f3166a, 0, m0Var);
        f fVarB = eVar.b();
        _checkCircleOutline = fVarB;
        return fVarB;
    }
}
