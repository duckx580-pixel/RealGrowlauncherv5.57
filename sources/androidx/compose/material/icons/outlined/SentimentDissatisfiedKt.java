...
public final class SentimentDissatisfiedKt {
    ...
    public static final f getSentimentDissatisfied(b bVar) {
        l.f("<this>", bVar);
        f fVar = _sentimentDissatisfied;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.SentimentDissatisfied", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
