...
public final class LibraryBooksKt {
    ...
    public static final f getLibraryBooks(b bVar) {
        l.f("<this>", bVar);
        f fVar = _libraryBooks;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.LibraryBooks", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarE, 10.0f, 9.0f, 8.0f, 2.0f);
        a.B(nVarE, -8.0f, 10.0f, 12.0f, 4.0f);
        k0.b.o(nVarE, 2.0f, -4.0f, 10.0f, 6.0f);
        k0.b.t(nVarE, 8.0f, 2.0f, -8.0f);
