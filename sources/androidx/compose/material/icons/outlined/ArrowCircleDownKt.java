...
public final class ArrowCircleDownKt {
    ...
    public static final f getArrowCircleDown(b bVar) {
        l.f("<this>", bVar);
        f fVar = _arrowCircleDown;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ArrowCircleDown", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.D(nVarA, 12.0f, 2.0f, 13.0f, 12.0f);
        nVarA.m(0.0f, -4.0f);
