...
public final class ReceiptLongKt {
    private static f _receiptLong;

    public static final f getReceiptLong(b bVar) {
        l.f("<this>", bVar);
        f fVar = _receiptLong;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ReceiptLong", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarC = a.c(19.5f, 3.5f, 18.0f, 2.0f);
        nVarC.m(-1.5f, 1.5f);
        nVarC.l(15.0f, 2.0f);
        nVarC.m(-1.5f, 1.5f);
        nVarC.l(12.0f, 2.0f);
        ...
        d.z(nVarC, 2.0f, 19.5f, 3.5f);
        nVarC.n(15.0f, 20.0f);
        nVarC.j(6.0f);
        nVarC.i(-0.55f, 0.0f, -1.0f, -0.45f, -1.0f, -1.0f);
        k0.b.q(nVarC, -1.0f, 10.0f, 20.0f);
        nVarC.n(19.0f, 19.0f);
        ...
        arrayList.add(new k1.n(9.0f, 7.0f));
        ...
        arrayList2.add(new k1.n(16.0f, 7.0f));
        ...
        arrayList3.add(new k1.n(9.0f, 10.0f));
        ...
        arrayList4.add(new k1.n(16.0f, 10.0f));
