...
public final class SportsGolfKt {
    ...
    public static final f getSportsGolf(b bVar) {
        l.f("<this>", bVar);
        f fVar = _sportsGolf;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.SportsGolf", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var5 = new m0(j);
        n nVarB = a.b(7.0f, 19.0f, 2.0f);
        nVarB.i(1.1f, 0.0f, 2.0f, 0.9f, 2.0f, 2.0f);
        a.x(nVarB, 1.0f, 2.0f, -1.0f);
