...
public final class BatteryAlertKt {
    ...
    public static final f getBatteryAlert(b bVar) {
        l.f("<this>", bVar);
        f fVar = _batteryAlert;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.BatteryAlert", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.i(nVarC, -2.0f, 11.0f, 9.0f, 2.0f);
        nVarC.t(5.0f);
        nVarC.g();
