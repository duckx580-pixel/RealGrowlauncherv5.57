...
public final class SafetyCheckKt {
    ...
    public static final f getSafetyCheck(b bVar) {
        l.f("<this>", bVar);
        f fVar = _safetyCheck;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.SafetyCheck", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarE.p(14.76f, 7.0f, 12.0f, 7.0f);
        c.g(nVarE, 13.65f, 14.35f, -2.15f, -2.15f);
        a.j(nVarE, 9.0f, 1.0f, 2.79f);
