...
public final class CameraAltKt {
    ...
    public static final f getCameraAlt(b bVar) {
        l.f("<this>", bVar);
        f fVar = _cameraAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.CameraAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.l(22.0f, 6.0f);
        nVarB.i(0.0f, -1.1f, -0.9f, -2.0f, -2.0f, -2.0f);
        a.n(nVarB, 20.0f, 18.0f, 4.0f, 18.0f);
        nVarB.l(4.0f, 6.0f);
        d.n(nVarB, 4.05f, 1.83f, -2.0f, 4.24f);
        nVarB.m(1.83f, 2.0f);
        a.v(nVarB, 20.0f, 6.0f, 12.0f);
        nVarB.n(12.0f, 7.0f);
