...
public final class InsertInvitationKt {
    ...
    public static final f getInsertInvitation(b bVar) {
        l.f("<this>", bVar);
        f fVar = _insertInvitation;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.InsertInvitation", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarB, 17.0f, 12.0f, -5.0f, 5.0f);
        a.i(nVarB, 5.0f, -5.0f);
