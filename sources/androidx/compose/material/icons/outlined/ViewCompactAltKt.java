...
public final class ViewCompactAltKt {
    ...
    public static final f getViewCompactAlt(b bVar) {
        l.f("<this>", bVar);
        f fVar = _viewCompactAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ViewCompactAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList.add(new k1.n(7.5f, 7.5f));
        ...
        arrayList2.add(new k1.n(12.5f, 7.5f));
        ...
        arrayList3.add(new k1.n(7.5f, 12.5f));
        ...
        arrayList4.add(new k1.n(12.5f, 12.5f));
