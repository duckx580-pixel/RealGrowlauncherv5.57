...
public final class ModeStandbyKt {
    private static f _modeStandby;

    public static final f getModeStandby(b bVar) {
        l.f("<this>", bVar);
        f fVar = _modeStandby;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.ModeStandby", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarA.p(15.0f, 10.34f, 15.0f, 12.0f);
        nVarA.g();
