...
public final class PictureInPictureKt {
    ...
    public static final f getPictureInPicture(b bVar) {
        l.f("<this>", bVar);
        f fVar = _pictureInPicture;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PictureInPicture", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = gb.e.c(19.0f, 7.0f, -8.0f, 6.0f, 8.0f);
        k0.b.D(nVarC, 19.0f, 7.0f, 17.0f, 11.0f);
        k0.b.i(nVarC, -4.0f, 13.0f, 9.0f, 4.0f);
        c.f(nVarC, 2.0f, 21.0f, 3.0f);
        nVarC.l(3.0f, 3.0f);
        ...
        a.y(nVarC, 3.0f, 4.98f, 18.0f, 14.03f);
