...
public final class MoveDownKt {
    ...
    public static final f getMoveDown(b bVar) {
        l.f("<this>", bVar);
        f fVar = _moveDown;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.MoveDown", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = a.a(3.0f, 11.0f);
        ...
        m0 m0Var2 = new m0(j);
        n nVarD = a.d(22.0f, 11.0f, 4.0f, -9.0f, 7.0f);
