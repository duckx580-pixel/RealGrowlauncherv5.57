...
public final class DoNotDisturbKt {
    private static f _doNotDisturb;

    public static final f getDoNotDisturb(b bVar) {
        l.f("<this>", bVar);
        f fVar = _doNotDisturb;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.DoNotDisturb", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
