...
public final class DoorFrontKt {
    private static f _doorFront;

    public static final f getDoorFront(b bVar) {
        l.f("<this>", bVar);
        f fVar = _doorFront;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.DoorFront", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarA, 13.0f, 11.0f, 2.0f, 2.0f);
        k0.b.g(nVarA, -2.0f, 11.0f);
