...
public final class SentimentSatisfiedKt {
    ...
    public static final f getSentimentSatisfied(b bVar) {
        l.f("<this>", bVar);
        f fVar = _sentimentSatisfied;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.SentimentSatisfied", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var3 = new m0(j);
        bj.n nVarA = a.a(12.0f, 16.0f);
        nVarA.i(-1.48f, 0.0f, -2.75f, -0.81f, -3.45f, -2.0f);
        nVarA.l(6.88f, 14.0f);
        nVarA.i(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        nVarA.q(4.32f, -1.45f, 5.12f, -3.5f);
        nVarA.k(-1.67f);
        nVarA.i(-0.7f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        nVarA.g();
        nVarA.n(11.99f, 2.0f);
