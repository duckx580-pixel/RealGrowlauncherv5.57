...
public final class EventNoteKt {
    ...
    public static final f getEventNote(b bVar) {
        l.f("<this>", bVar);
        f fVar = _eventNote;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.EventNote", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.D(nVarB, 5.0f, 7.0f, 7.0f, 11.0f);
        k0.e.o(nVarB, 10.0f, 2.0f, 7.0f, 13.0f);
        a.p(nVarB, 7.0f, 15.0f, 7.0f, 2.0f);
        nVarB.l(7.0f, 17.0f);
        nVarB.g();
