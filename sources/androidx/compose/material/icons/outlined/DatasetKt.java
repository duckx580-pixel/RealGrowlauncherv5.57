...
public final class DatasetKt {
    ...
    public static final f getDataset(b bVar) {
        l.f("<this>", bVar);
        f fVar = _dataset;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Dataset", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(7.0f, 13.0f));
        ...
        arrayList2.add(new n(13.0f, 13.0f));
        ...
        arrayList3.add(new n(7.0f, 7.0f));
        ...
        arrayList4.add(new n(13.0f, 7.0f));
