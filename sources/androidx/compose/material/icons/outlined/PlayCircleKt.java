...
public final class PlayCircleKt {
    ...
    public static final f getPlayCircle(b bVar) {
        l.f("<this>", bVar);
        f fVar = _playCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PlayCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        c.g(nVarA, 9.5f, 16.5f, 7.0f, -4.5f);
        d.v(nVarA, -7.0f, -4.5f, 16.5f);
