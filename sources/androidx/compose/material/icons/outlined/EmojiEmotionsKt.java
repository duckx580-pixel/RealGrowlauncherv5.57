...
public final class EmojiEmotionsKt {
    private static f _emojiEmotions;

    public static final f getEmojiEmotions(b bVar) {
        l.f("<this>", bVar);
        f fVar = _emojiEmotions;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.EmojiEmotions", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList3.add(new n(12.0f, 18.0f));
        arrayList3.add(new s(2.28f, 0.0f, 4.22f, -1.66f, 5.0f, -4.0f));
        arrayList3.add(new k1.l(7.0f));
        arrayList3.add(new k(7.78f, 16.34f, 9.72f, 18.0f, 12.0f, 18.0f));
        arrayList3.add(j.f9075c);
        e.a(eVar, arrayList3, 0, m0Var3);
        m0 m0Var4 = new m0(j);
        bj.n nVarA = a.a(11.99f, 2.0f);
        nVarA.h(6.47f, 2.0f, 2.0f, 6.48f, 2.0f, 12.0f);
        nVarA.i(0.0f, 5.52f, 4.47f, 10.0f, 9.99f, 10.0f);
        nVarA.h(17.52f, 22.0f, 22.0f, 17.52f, 22.0f, 12.0f);
        nVarA.h(22.0f, 6.48f, 17.52f, 2.0f, 11.99f, 2.0f);
        nVarA.g();
        nVarA.n(12.0f, 20.0f);
