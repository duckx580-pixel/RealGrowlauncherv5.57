...
public final class AutoDeleteKt {
    ...
    public static final f getAutoDelete(b bVar) {
        l.f("<this>", bVar);
        f fVar = _autoDelete;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.AutoDelete", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.m(-1.0f, 1.0f);
        nVarB.m(-3.5f, 0.0f);
        a.k(nVarB, 0.0f, 2.0f, 14.0f, 0.0f);
        e.a(eVar, nVarB.f3166a, 0, m0Var);
        m0 m0Var2 = new m0(j);
        n nVarA = a.a(16.0f, 9.0f);
        ...
        nVarA.g();
        nVarA.n(9.0f, 16.0f);
        nVarA.i(0.0f, 0.34f, 0.03f, 0.67f, 0.08f, 1.0f);
        k0.f.D(nVarA, 4.0f, 7.0f, 8.0f, 3.26f);
        nVarA.h(10.19f, 11.53f, 9.0f, 13.62f, 9.0f, 16.0f);
        nVarA.g();
        nVarA.n(16.0f, 21.0f);
