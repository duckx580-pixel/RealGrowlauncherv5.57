...
public final class AnnouncementKt {
    ...
    public static final f getAnnouncement(b bVar) {
        l.f("<this>", bVar);
        f fVar = _announcement;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Announcement", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        a.p(nVarC, 11.0f, 5.0f, 2.0f, 6.0f);
        a.B(nVarC, -2.0f, 11.0f, 13.0f, 2.0f);
        k0.b.s(nVarC, 2.0f, -2.0f);
