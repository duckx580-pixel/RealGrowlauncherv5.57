...
public final class PauseCircleFilledKt {
    ...
    public static final f getPauseCircleFilled(b bVar) {
        l.f("<this>", bVar);
        f fVar = _pauseCircleFilled;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PauseCircleFilled", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.b.B(nVarA, 11.0f, 16.0f, 9.0f, 8.0f);
        gb.e.r(nVarA, 2.0f, 16.0f, 15.0f, 16.0f);
        d.D(nVarA, -2.0f, 8.0f, 2.0f, 16.0f);
