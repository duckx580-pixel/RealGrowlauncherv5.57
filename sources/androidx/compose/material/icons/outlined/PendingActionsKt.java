...
public final class PendingActionsKt {
    ...
    public static final f getPendingActions(b bVar) {
        l.f("<this>", bVar);
        f fVar = _pendingActions;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.PendingActions", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(17.0f, 12.0f);
        ...
        a.D(nVarA, 8.0f, 5.0f, 2.0f, 5.08f);
