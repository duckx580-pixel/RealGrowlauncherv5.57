...
public final class StoreMallDirectoryKt {
    private static f _storeMallDirectory;

    public static final f getStoreMallDirectory(b bVar) {
        l.f("<this>", bVar);
        f fVar = _storeMallDirectory;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.StoreMallDirectory", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
