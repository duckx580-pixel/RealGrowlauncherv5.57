...
public final class ErrorKt {
    ...
    public static final f getError(b bVar) {
        l.f("<this>", bVar);
        f fVar = _error;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Error", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        d.r(nVarA, 2.0f, 2.0f, 13.0f, 13.0f);
        k0.b.i(nVarA, -2.0f, 11.0f, 7.0f, 2.0f);
        nVarA.t(6.0f);
        nVarA.g();
