...
public final class AttributionKt {
    ...
    public static final f getAttribution(b bVar) {
        l.f("<this>", bVar);
        f fVar = _attribution;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Attribution", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = a.a(12.0f, 8.5f);
        nVarA.i(-0.91f, 0.0f, -2.75f, 0.46f, -2.75f, 1.38f);
        k0.b.u(nVarA, 4.62f, 1.5f, 10.75f, 19.0f);
        k0.b.v(nVarA, 2.5f, -4.5f, 1.5f);
