...
public final class HttpsKt {
    ...
    public static final f getHttps(b bVar) {
        l.f("<this>", bVar);
        f fVar = _https;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Https", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarB.t(2.0f);
        c.p(nVarB, 9.0f, 8.0f, 9.0f, 6.0f);
        nVarB.n(18.0f, 20.0f);
        nVarB.l(6.0f, 20.0f);
        a.y(nVarB, 6.0f, 10.0f, 12.0f, 10.0f);
        nVarB.n(12.0f, 17.0f);
        nVarB.i(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
