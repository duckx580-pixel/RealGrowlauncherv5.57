...
public final class KeyboardVoiceKt {
    ...
    public static final f getKeyboardVoice(b bVar) {
        l.f("<this>", bVar);
        f fVar = _keyboardVoice;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.KeyboardVoice", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(12.0f, 15.0f);
        ...
        nVarA.q(1.2f, 0.54f, 1.2f, 1.2f);
        nVarA.m(-0.01f, 6.2f);
        nVarA.i(0.0f, 0.66f, -0.53f, 1.2f, -1.19f, 1.2f);
        nVarA.q(-1.2f, -0.54f, -1.2f, -1.2f);
        k0.b.D(nVarA, 10.8f, 5.9f, 17.3f, 12.0f);
