...
public final class ScreenshotKt {
    ...
    public static final f getScreenshot(b bVar) {
        l.f("<this>", bVar);
        f fVar = _screenshot;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Screenshot", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        gb.e.r(nVarC, 10.0f, 4.0f, 9.5f, 8.5f);
        nVarC.j(12.0f);
        nVarC.s(7.0f);
        nVarC.j(8.0f);
        nVarC.t(4.0f);
        gb.e.r(nVarC, 1.5f, 8.5f, 12.0f, 17.0f);
        a.w(nVarC, 4.0f, -4.0f, -1.5f, 2.5f);
        k0.b.c(nVarC, 12.0f, 17.0f);
