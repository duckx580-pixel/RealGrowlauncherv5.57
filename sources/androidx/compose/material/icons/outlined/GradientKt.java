...
public final class GradientKt {
    ...
    public static final f getGradient(b bVar) {
        l.f("<this>", bVar);
        f fVar = _gradient;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Gradient", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = gb.e.c(11.0f, 9.0f, 2.0f, 2.0f, -2.0f);
        k0.b.D(nVarC, 11.0f, 9.0f, 9.0f, 11.0f);
        k0.b.r(nVarC, 2.0f, 2.0f, 9.0f, 13.0f);
        ...
        c.p(nVarC, 7.0f, 11.0f, 7.0f, 9.0f);
        nVarC.n(19.0f, 3.0f);
        nVarC.l(5.0f, 3.0f);
        ...
        a.w(nVarC, -2.0f, 2.0f, -2.0f, -2.0f);
        k0.b.r(nVarC, -2.0f, 2.0f, 9.0f, 15.0f);
        d.o(nVarC, -2.0f, 7.0f, 13.0f, 2.0f);
        gb.e.o(nVarC, 5.0f, 15.0f, -2.0f, 2.0f);
        nVarC.t(-2.0f);
        nVarC.l(5.0f, 11.0f);
        a.y(nVarC, 5.0f, 5.0f, 14.0f, 6.0f);
