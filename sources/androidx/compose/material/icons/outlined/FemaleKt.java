...
public final class FemaleKt {
    ...
    public static final f getFemale(b bVar) {
        l.f("<this>", bVar);
        f fVar = _female;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Outlined.Female", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = a.a(17.5f, 9.5f);
        ...
        a.A(nVarA, 2.0f, 2.0f, -2.0f, 2.0f);
        a.x(nVarA, -2.0f, -2.0f, -2.1f);
