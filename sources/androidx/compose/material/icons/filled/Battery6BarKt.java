...
public final class Battery6BarKt {
    private static f _battery6Bar;

    public static final f getBattery6Bar(a aVar) {
        l.f("<this>", aVar);
        f fVar = _battery6Bar;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Battery6Bar", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.C(nVarL, 15.0f, 6.0f, 9.0f, 2.0f);
        b.g(nVarL, 6.0f, 6.0f);
