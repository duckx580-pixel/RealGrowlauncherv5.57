...
public final class SpatialAudioOffKt {
    ...
    public static final f getSpatialAudioOff(a aVar) {
        l.f("<this>", aVar);
        f fVar = _spatialAudioOff;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SpatialAudioOff", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList2.add(new n(20.36f, 1.0f));
        arrayList2.add(new u(-1.41f, 1.41f));
        arrayList2.add(new s(2.73f, 2.73f, 2.73f, 7.17f, 0.0f, 9.9f));
        arrayList2.add(new u(1.41f, 1.41f));
        arrayList2.add(new k(23.88f, 10.21f, 23.88f, 4.51f, 20.36f, 1.0f));
        j jVar = j.f9075c;
        arrayList2.add(jVar);
        e.a(eVar, arrayList2, 0, m0Var3);
        m0 m0Var4 = new m0(j);
        ArrayList arrayList3 = new ArrayList(32);
        arrayList3.add(new n(17.54f, 10.9f));
        arrayList3.add(new s(1.95f, -1.95f, 1.95f, -5.12f, 0.0f, -7.07f));
        arrayList3.add(new u(-1.41f, 1.41f));
        k0.f.e(arrayList3, new s(1.17f, 1.17f, 1.17f, 3.07f, 0.0f, 4.24f), 17.54f, 10.9f, jVar);
