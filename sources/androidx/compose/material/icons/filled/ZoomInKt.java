...
public final class ZoomInKt {
    private static f _zoomIn;

    public static final f getZoomIn(a aVar) {
        l.f("<this>", aVar);
        f fVar = _zoomIn;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.ZoomIn", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var2 = new m0(j);
        n nVarY = k0.f.y(12.0f, 10.0f, -2.0f, 2.0f, 9.0f);
        nVarY.t(-2.0f);
        nVarY.j(7.0f);
        nVarY.s(9.0f);
        nVarY.k(2.0f);
        b.n(nVarY, 7.0f, 1.0f, 2.0f, 2.0f);
        nVarY.t(1.0f);
        nVarY.g();
