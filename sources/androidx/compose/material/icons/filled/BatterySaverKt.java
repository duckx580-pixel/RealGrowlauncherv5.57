...
public final class BatterySaverKt {
    ...
    public static final f getBatterySaver(a aVar) {
        l.f("<this>", aVar);
        f fVar = _batterySaver;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.BatterySaver", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.u(nVarB, 15.0f, 14.0f, -2.0f, 2.0f);
        k0.a.r(nVarB, -2.0f, -2.0f, 9.0f, -2.0f);
