...
public final class NetworkPingKt {
    ...
    public static final f getNetworkPing(a aVar) {
        l.f("<this>", aVar);
        f fVar = _networkPing;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.NetworkPing", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = k0.a.c(12.0f, 14.67f, 3.41f, 6.09f);
        nVarC.l(2.0f, 7.5f);
        k0.f.A(nVarC, 8.5f, 8.5f, 4.0f, 2.0f);
        b.v(nVarC, 16.0f, -2.0f, -6.5f);
        nVarC.m(5.15f, -5.15f);
