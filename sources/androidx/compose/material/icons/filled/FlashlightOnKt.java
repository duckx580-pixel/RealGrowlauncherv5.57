...
public final class FlashlightOnKt {
    ...
    public static final f getFlashlightOn(a aVar) {
        l.f("<this>", aVar);
        f fVar = _flashlightOn;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.FlashlightOn", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(6.0f, 2.0f));
        ...
        m0 m0Var2 = new m0(j);
        bj.n nVarT = c.t(6.0f, 7.0f, 1.0f, 2.0f, 3.0f);
        k0.a.m(nVarT, 11.0f, 8.0f, 11.0f);
        k0.f.o(nVarT, 2.0f, -3.0f, 7.0f, 6.0f);
        nVarT.n(12.0f, 15.5f);
