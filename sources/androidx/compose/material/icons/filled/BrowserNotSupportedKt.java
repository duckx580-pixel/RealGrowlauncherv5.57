...
public final class BrowserNotSupportedKt {
    ...
    public static final f getBrowserNotSupported(a aVar) {
        l.f("<this>", aVar);
        f fVar = _browserNotSupported;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.BrowserNotSupported", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var2 = new m0(j);
        n nVarC = k0.a.c(3.22f, 3.32f, 1.95f, 4.59f);
        nVarC.l(3.0f, 5.64f);
        nVarC.l(3.0f, 18.0f);
