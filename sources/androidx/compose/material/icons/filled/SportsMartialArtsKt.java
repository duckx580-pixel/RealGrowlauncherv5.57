...
public final class SportsMartialArtsKt {
    ...
    public static final f getSportsMartialArts(a aVar) {
        l.f("<this>", aVar);
        f fVar = _sportsMartialArts;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SportsMartialArts", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.m(0.5f, 9.0f);
        nVarB.m(2.0f, 0.0f);
        k0.a.k(nVarB, 0.5f, -10.0f, 8.5f, -8.6f);
