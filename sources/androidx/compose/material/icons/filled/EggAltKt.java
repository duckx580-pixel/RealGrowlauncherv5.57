...
public final class EggAltKt {
    ...
    public static final f getEggAlt(a aVar) {
        l.f("<this>", aVar);
        f fVar = _eggAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.EggAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.a.a(19.0f, 9.0f);
        ...
        nVarA.p(13.93f, 15.5f, 12.0f, 15.5f);
        nVarA.g();
