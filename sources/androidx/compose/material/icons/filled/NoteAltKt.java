...
public final class NoteAltKt {
    ...
    public static final f getNoteAlt(a aVar) {
        l.f("<this>", aVar);
        f fVar = _noteAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.NoteAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.C(nVarB, 9.1f, 17.0f, 7.0f, -2.14f);
        nVarB.m(5.96f, -5.96f);
        gb.e.p(nVarB, 2.12f, 2.12f, 9.1f, 17.0f);
        nVarB.n(16.85f, 9.27f);
        nVarB.m(-1.06f, 1.06f);
        nVarB.m(-2.12f, -2.12f);
        nVarB.m(1.06f, -1.06f);
        nVarB.i(0.2f, -0.2f, 0.51f, -0.2f, 0.71f, 0.0f);
        nVarB.m(1.41f, 1.41f);
        nVarB.h(17.05f, 8.76f, 17.05f, 9.07f, 16.85f, 9.27f);
        nVarB.g();
