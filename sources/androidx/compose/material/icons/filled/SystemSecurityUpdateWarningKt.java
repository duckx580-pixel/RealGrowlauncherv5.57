...
public final class SystemSecurityUpdateWarningKt {
    ...
    public static final f getSystemSecurityUpdateWarning(a aVar) {
        l.f("<this>", aVar);
        f fVar = _systemSecurityUpdateWarning;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SystemSecurityUpdateWarning", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var3 = new m0(j);
        bj.n nVarS = k0.a.s(17.0f, 1.0f, 7.0f);
