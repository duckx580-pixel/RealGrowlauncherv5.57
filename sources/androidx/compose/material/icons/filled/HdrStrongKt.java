...
public final class HdrStrongKt {
    private static f _hdrStrong;

    public static final f getHdrStrong(a aVar) {
        l.f("<this>", aVar);
        f fVar = _hdrStrong;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.HdrStrong", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.a.a(17.0f, 6.0f);
