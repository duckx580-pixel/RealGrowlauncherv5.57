...
public final class CameraOutdoorKt {
    ...
    public static final f getCameraOutdoor(a aVar) {
        l.f("<this>", aVar);
        f fVar = _cameraOutdoor;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.CameraOutdoor", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.a.a(18.0f, 13.0f);
