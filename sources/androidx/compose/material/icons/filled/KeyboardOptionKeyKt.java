...
public final class KeyboardOptionKeyKt {
    ...
    public static final f getKeyboardOptionKey(a aVar) {
        l.f("<this>", aVar);
        f fVar = _keyboardOptionKey;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.KeyboardOptionKey", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.m(6.92f, 12.0f);
        nVarB.m(6.23f, 0.0f);
        k0.a.k(nVarB, 0.0f, -2.0f, -5.07f, 0.0f);
