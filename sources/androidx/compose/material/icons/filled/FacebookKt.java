...
public final class FacebookKt {
    ...
    public static final f getFacebook(a aVar) {
        l.f("<this>", aVar);
        f fVar = _facebook;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Facebook", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.a.a(22.0f, 12.0f);
        ...
        c.l(nVarA, 16.0f, 3.0f, -2.0f);
        nVarA.i(-0.55f, 0.0f, -1.0f, 0.45f, -1.0f, 1.0f);
        k0.a.A(nVarA, 2.0f, 3.0f, 3.0f, -3.0f);
        nVarA.t(6.95f);
