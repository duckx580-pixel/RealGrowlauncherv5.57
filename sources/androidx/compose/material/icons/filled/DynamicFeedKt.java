...
public final class DynamicFeedKt {
    ...
    public static final f getDynamicFeed(a aVar) {
        l.f("<this>", aVar);
        f fVar = _dynamicFeed;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.DynamicFeed", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        m0 m0Var2 = new m0(j);
        n nVarB = k0.a.b(20.0f, 3.0f, -8.0f);
