...
public final class LyricsKt {
    ...
    public static final f getLyrics(a aVar) {
        l.f("<this>", aVar);
        f fVar = _lyrics;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Lyrics", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = k0.a.a(14.0f, 9.0f);
        ...
        k0.a.C(nVarA, 10.0f, 14.0f, 6.0f, -2.0f);
