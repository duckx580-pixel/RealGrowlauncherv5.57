...
public final class MoveToInboxKt {
    private static f _moveToInbox;

    public static final f getMoveToInbox(a aVar) {
        l.f("<this>", aVar);
        f fVar = _moveToInbox;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.MoveToInbox", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        nVarC.n(16.0f, 10.0f);
        b.i(nVarC, -2.0f, 14.0f, 7.0f, -4.0f);
        nVarC.t(3.0f);
        nVarC.l(8.0f, 10.0f);
