...
public final class PaymentKt {
    private static f _payment;

    public static final f getPayment(a aVar) {
        l.f("<this>", aVar);
        f fVar = _payment;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Payment", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
