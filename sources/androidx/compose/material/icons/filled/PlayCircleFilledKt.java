...
public final class PlayCircleFilledKt {
    ...
    public static final f getPlayCircleFilled(a aVar) {
        l.f("<this>", aVar);
        f fVar = _playCircleFilled;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.PlayCircleFilled", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        b.z(nVarA, 10.0f, 16.5f, -9.0f);
        k0.a.k(nVarA, 6.0f, 4.5f, -6.0f, 4.5f);
