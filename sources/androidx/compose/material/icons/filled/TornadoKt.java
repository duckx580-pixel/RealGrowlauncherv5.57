...
public final class TornadoKt {
    ...
    public static final f getTornado(a aVar) {
        l.f("<this>", aVar);
        f fVar = _tornado;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Tornado", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ArrayList arrayList = new ArrayList(32);
        arrayList.add(new n(20.11f, 8.0f));
        arrayList.add(new u(2.89f, -5.0f));
        d.c(-22.0f, 0.0f, 2.89f, 5.0f, arrayList);
        j jVar = j.f9075c;
        arrayList.add(jVar);
        ...
        arrayList2.add(new u(4.05f, 7.0f));
        k0.a.f(4.05f, -7.0f, arrayList2, jVar);
