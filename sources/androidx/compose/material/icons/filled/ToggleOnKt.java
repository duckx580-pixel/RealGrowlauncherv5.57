...
public final class ToggleOnKt {
    private static f _toggleOn;

    public static final f getToggleOn(a aVar) {
        l.f("<this>", aVar);
        f fVar = _toggleOn;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.ToggleOn", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = k0.a.c(17.0f, 7.0f, 7.0f, 7.0f);
