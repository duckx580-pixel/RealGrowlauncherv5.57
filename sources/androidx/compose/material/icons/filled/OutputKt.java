...
public final class OutputKt {
    ...
    public static final f getOutput(a aVar) {
        l.f("<this>", aVar);
        f fVar = _output;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Output", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.m(-9.17f, 0.0f);
        nVarB.m(0.0f, 2.0f);
        k0.a.k(nVarB, 9.17f, 0.0f, -2.58f, 2.59f);
        e.a(eVar, nVarB.f3166a, 0, m0Var);
        m0 m0Var2 = new m0(j);
        n nVarW = c.w(19.0f, 19.0f, 5.0f, 5.0f, 14.0f);
        k0.a.m(nVarW, 2.0f, 2.0f, 5.0f);
