...
public final class ReviewsKt {
    ...
    public static final f getReviews(a aVar) {
        l.f("<this>", aVar);
        f fVar = _reviews;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Reviews", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.n(nVarS, 13.57f, 11.57f, 12.0f, 15.0f);
        nVarS.m(-1.57f, -3.43f);
        nVarS.l(7.0f, 10.0f);
        nVarS.m(3.43f, -1.57f);
        nVarS.l(12.0f, 5.0f);
        nVarS.m(1.57f, 3.43f);
        c.p(nVarS, 17.0f, 10.0f, 13.57f, 11.57f);
