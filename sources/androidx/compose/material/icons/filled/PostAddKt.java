...
public final class PostAddKt {
    ...
    public static final f getPostAdd(a aVar) {
        l.f("<this>", aVar);
        f fVar = _postAdd;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.PostAdd", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList2.add(new u(0.0f, -2.0f));
        k0.a.f(-3.0f, 0.0f, arrayList2, jVar);
