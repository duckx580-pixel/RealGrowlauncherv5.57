...
public final class SpeakerGroupKt {
    ...
    public static final f getSpeakerGroup(a aVar) {
        l.f("<this>", aVar);
        f fVar = _speakerGroup;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SpeakerGroup", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarC = k0.a.c(18.2f, 1.0f, 9.8f, 1.0f);
        ...
        m0 m0Var3 = new m0(j);
        n nVarA = k0.f.a(6.0f, 5.0f, 4.0f, 16.0f);
        nVarA.i(0.0f, 1.1f, 0.89f, 2.0f, 2.0f, 2.0f);
        d.y(nVarA, 10.0f, -2.0f, 6.0f, 5.0f);
