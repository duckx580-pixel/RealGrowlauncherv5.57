...
public final class SportsGolfKt {
    private static f _sportsGolf;

    public static final f getSportsGolf(a aVar) {
        l.f("<this>", aVar);
        f fVar = _sportsGolf;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SportsGolf", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = k0.a.a(12.0f, 16.0f);
        nVarA.i(3.87f, 0.0f, 7.0f, -3.13f, 7.0f, -7.0f);
        nVarA.i(0.0f, -3.87f, -3.13f, -7.0f, -7.0f, -7.0f);
        nVarA.p(5.0f, 5.13f, 5.0f, 9.0f);
        nVarA.h(5.0f, 12.87f, 8.13f, 16.0f, 12.0f, 16.0f);
        nVarA.g();
        nVarA.n(12.0f, 4.0f);
        nVarA.i(2.76f, 0.0f, 5.0f, 2.24f, 5.0f, 5.0f);
        nVarA.q(-2.24f, 5.0f, -5.0f, 5.0f);
        nVarA.q(-5.0f, -2.24f, -5.0f, -5.0f);
        nVarA.p(9.24f, 4.0f, 12.0f, 4.0f);
        nVarA.g();
        ...
        arrayList2.add(new k1.n(14.0f, 8.0f));
