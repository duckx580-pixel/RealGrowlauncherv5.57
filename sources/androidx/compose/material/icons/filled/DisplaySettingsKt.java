...
public final class DisplaySettingsKt {
    ...
    public static final f getDisplaySettings(a aVar) {
        l.f("<this>", aVar);
        f fVar = _displaySettings;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.DisplaySettings", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarB.m(0.0f, -1.25f);
        nVarB.m(-1.5f, 0.0f);
        k0.a.k(nVarB, 0.0f, 4.0f, 1.5f, 0.0f);
        ...
        nVarB2.m(0.0f, 1.25f);
        nVarB2.m(-1.5f, 0.0f);
        k0.a.k(nVarB2, 0.0f, 1.5f, 1.5f, 0.0f);
