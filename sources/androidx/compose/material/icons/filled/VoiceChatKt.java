...
public final class VoiceChatKt {
    ...
    public static final f getVoiceChat(a aVar) {
        l.f("<this>", aVar);
        f fVar = _voiceChat;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.VoiceChat", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList.add(new k1.n(11.25f, 5.0f));
        ...
        arrayList2.add(new k1.n(8.5f, 7.0f));
        ...
        arrayList3.add(new k1.n(6.0f, 9.0f));
        ...
        arrayList4.add(new k1.n(14.0f, 7.0f));
        ...
        arrayList5.add(new k1.n(16.5f, 9.0f));
        arrayList5.add(new k1.t(1.5f));
        arrayList5.add(new z(2.0f));
        k0.a.h(-1.5f, arrayList5, jVar);
