...
public final class PlayCircleKt {
    ...
    public static final f getPlayCircle(a aVar) {
        l.f("<this>", aVar);
        f fVar = _playCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.PlayCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        b.z(nVarA, 9.5f, 16.5f, -9.0f);
        gb.e.p(nVarA, 7.0f, 4.5f, 9.5f, 16.5f);
