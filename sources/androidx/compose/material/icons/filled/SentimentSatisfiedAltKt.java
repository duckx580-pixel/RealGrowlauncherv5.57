...
public final class SentimentSatisfiedAltKt {
    ...
    public static final f getSentimentSatisfiedAlt(a aVar) {
        l.f("<this>", aVar);
        f fVar = _sentimentSatisfiedAlt;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SentimentSatisfiedAlt", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList3.add(new n(15.5f, 9.5f));
        ...
        arrayList4.add(new n(8.5f, 9.5f));
        ...
        nVarA.g();
        nVarA.n(12.0f, 17.5f);
        nVarA.i(2.33f, 0.0f, 4.32f, -1.45f, 5.12f, -3.5f);
        nVarA.k(-1.67f);
        nVarA.i(-0.69f, 1.19f, -1.97f, 2.0f, -3.45f, 2.0f);
        nVarA.q(-2.75f, -0.81f, -3.45f, -2.0f);
        nVarA.l(6.88f, 14.0f);
        nVarA.i(0.8f, 2.05f, 2.79f, 3.5f, 5.12f, 3.5f);
        nVarA.g();
