...
public final class FlagCircleKt {
    ...
    public static final f getFlagCircle(a aVar) {
        l.f("<this>", aVar);
        f fVar = _flagCircle;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.FlagCircle", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.t(nVarA, 18.0f, 15.0f, -5.0f);
        k0.f.A(nVarA, -1.0f, -2.0f, 9.5f, 5.0f);
        k0.f.q(nVarA, 8.0f, 7.0f, 6.0f);
        nVarA.m(1.0f, 2.0f);
        nVarA.k(3.0f);
        nVarA.s(15.0f);
        nVarA.g();
