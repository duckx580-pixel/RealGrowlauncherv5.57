...
public final class HeadsetKt {
    ...
    public static final f getHeadset(a aVar) {
        l.f("<this>", aVar);
        f fVar = _headset;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Headset", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarA = k0.a.a(12.0f, 1.0f);
        nVarA.i(-4.97f, 0.0f, -9.0f, 4.03f, -9.0f, 9.0f);
        nVarA.t(7.0f);
        nVarA.i(0.0f, 1.66f, 1.34f, 3.0f, 3.0f, 3.0f);
        k0.a.r(nVarA, 3.0f, -8.0f, 5.0f, -2.0f);
        nVarA.i(0.0f, -3.87f, 3.13f, -7.0f, 7.0f, -7.0f);
        nVarA.q(7.0f, 3.13f, 7.0f, 7.0f);
        k0.a.A(nVarA, 2.0f, -4.0f, 8.0f, 3.0f);
