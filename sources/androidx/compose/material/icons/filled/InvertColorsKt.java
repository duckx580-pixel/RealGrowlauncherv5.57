...
public final class InvertColorsKt {
    ...
    public static final f getInvertColors(a aVar) {
        l.f("<this>", aVar);
        f fVar = _invertColors;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.InvertColors", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = k0.a.c(12.0f, 4.81f, 12.0f, 19.0f);
        ...
        nVarC.m(0.0f, 0.0f);
        c.p(nVarC, 12.0f, 2.0f, 6.35f, 7.56f);
