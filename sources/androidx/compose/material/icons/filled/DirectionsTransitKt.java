...
public final class DirectionsTransitKt {
    ...
    public static final f getDirectionsTransit(a aVar) {
        l.f("<this>", aVar);
        f fVar = _directionsTransit;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.DirectionsTransit", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        ...
        k0.a.n(nVarA, 11.0f, 11.0f, 6.0f, 11.0f);
        k0.a.y(nVarA, 6.0f, 6.0f, 5.0f, 5.0f);
        nVarA.n(16.5f, 17.0f);
        nVarA.i(-0.83f, 0.0f, -1.5f, -0.67f, -1.5f, -1.5f);
        nVarA.q(0.67f, -1.5f, 1.5f, -1.5f);
        nVarA.q(1.5f, 0.67f, 1.5f, 1.5f);
        nVarA.q(-0.67f, 1.5f, -1.5f, 1.5f);
        k0.a.t(nVarA, 18.0f, 11.0f, -5.0f);
        k0.a.y(nVarA, 13.0f, 6.0f, 5.0f, 5.0f);
