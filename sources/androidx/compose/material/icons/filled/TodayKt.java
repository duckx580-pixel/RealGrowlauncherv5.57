...
public final class TodayKt {
    ...
    public static final f getToday(a aVar) {
        l.f("<this>", aVar);
        f fVar = _today;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Today", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = c.b(19.0f, 3.0f, -1.0f, 18.0f, 1.0f);
        b.r(nVarB, -2.0f, 2.0f, 8.0f, 3.0f);
        nVarB.l(8.0f, 1.0f);
        nVarB.l(6.0f, 1.0f);
        nVarB.t(2.0f);
        nVarB.l(5.0f, 3.0f);
        ...
        k0.a.n(nVarB, 19.0f, 19.0f, 5.0f, 19.0f);
        k0.a.y(nVarB, 5.0f, 8.0f, 14.0f, 11.0f);
        k0.a.p(nVarB, 7.0f, 10.0f, 5.0f, 5.0f);
        nVarB.l(7.0f, 15.0f);
        nVarB.g();
