...
public final class SignalWifi4BarLockKt {
    private static f _signalWifi4BarLock;

    public static final f getSignalWifi4BarLock(a aVar) {
        l.f("<this>", aVar);
        f fVar = _signalWifi4BarLock;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SignalWifi4BarLock", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarC = k0.a.c(21.98f, 11.0f, 24.0f, 8.98f);
        ...
        m0 m0Var2 = new m0(j);
        n nVarL = k0.a.l(22.0f, 16.0f, -1.0f);
        ...
        k0.a.u(nVarL, 21.0f, 16.0f, -2.0f, -1.0f);
        nVarL.i(0.0f, -0.55f, 0.45f, -1.0f, 1.0f, -1.0f);
