...
public final class InstallDesktopKt {
    ...
    public static final f getInstallDesktop(a aVar) {
        l.f("<this>", aVar);
        f fVar = _installDesktop;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.InstallDesktop", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        k0.a.w(nVarW, 4.0f, 2.0f, 8.0f, -2.0f);
        nVarW.k(4.0f);
        nVarW.i(1.1f, 0.0f, 2.0f, -0.9f, 2.0f, -2.0f);
        b.q(nVarW, -3.0f, -2.0f, 17.0f);
        ...
        nVarB.m(-2.0f, 0.0f);
        nVarB.m(0.0f, 7.17f);
        k0.a.k(nVarB, -2.59f, -2.58f, -1.41f, 1.41f);
