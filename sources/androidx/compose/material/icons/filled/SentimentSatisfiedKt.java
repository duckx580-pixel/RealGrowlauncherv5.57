...
public final class SentimentSatisfiedKt {
    ...
    public static final f getSentimentSatisfied(a aVar) {
        l.f("<this>", aVar);
        f fVar = _sentimentSatisfied;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SentimentSatisfied", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        nVarA.g();
        nVarA.n(12.0f, 16.0f);
        nVarA.i(-0.73f, 0.0f, -1.38f, -0.18f, -1.96f, -0.52f);
        nVarA.i(-0.12f, 0.14f, -0.86f, 0.98f, -1.01f, 1.15f);
        nVarA.i(0.86f, 0.55f, 1.87f, 0.87f, 2.97f, 0.87f);
        nVarA.i(1.11f, 0.0f, 2.12f, -0.33f, 2.98f, -0.88f);
        nVarA.i(-0.97f, -1.09f, -0.01f, -0.02f, -1.01f, -1.15f);
        nVarA.i(-0.59f, 0.35f, -1.24f, 0.53f, -1.97f, 0.53f);
        nVarA.g();
