...
public final class PermDeviceInformationKt {
    ...
    public static final f getPermDeviceInformation(a aVar) {
        l.f("<this>", aVar);
        f fVar = _permDeviceInformation;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.PermDeviceInformation", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = gb.e.c(13.0f, 7.0f, -2.0f, 2.0f, 2.0f);
        b.D(nVarC, 13.0f, 7.0f, 13.0f, 11.0f);
        b.w(nVarC, -2.0f, 6.0f, 2.0f, -6.0f);
        nVarC.n(17.0f, 1.01f);
        nVarC.l(7.0f, 1.0f);
