...
public final class LocalMallKt {
    private static f _localMall;

    public static final f getLocalMall(a aVar) {
        l.f("<this>", aVar);
        f fVar = _localMall;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.LocalMall", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarB = k0.a.b(19.0f, 6.0f, -2.0f);
