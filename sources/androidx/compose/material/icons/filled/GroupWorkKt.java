...
public final class GroupWorkKt {
    private static f _groupWork;

    public static final f getGroupWork(a aVar) {
        l.f("<this>", aVar);
        f fVar = _groupWork;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.GroupWork", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
