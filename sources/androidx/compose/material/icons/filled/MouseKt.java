...
public final class MouseKt {
    ...
    public static final f getMouse(a aVar) {
        l.f("<this>", aVar);
        f fVar = _mouse;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.Mouse", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarQ = c.q(13.0f, 1.07f, 13.0f, 9.0f, 7.0f);
        nVarQ.i(0.0f, -4.08f, -3.05f, -7.44f, -7.0f, -7.93f);
        nVarQ.g();
        nVarQ.n(4.0f, 15.0f);
        nVarQ.i(0.0f, 4.42f, 3.58f, 8.0f, 8.0f, 8.0f);
        nVarQ.q(8.0f, -3.58f, 8.0f, -8.0f);
        k0.a.q(nVarQ, -4.0f, 4.0f, 11.0f, 4.0f);
        nVarQ.n(11.0f, 1.07f);
