...
public final class SupportAgentKt {
    ...
    public static final f getSupportAgent(a aVar) {
        l.f("<this>", aVar);
        f fVar = _supportAgent;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SupportAgent", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        n nVarA = k0.a.a(21.0f, 12.22f);
        ...
        b.n(nVarA, 19.0f, -8.0f, 2.0f, 8.0f);
