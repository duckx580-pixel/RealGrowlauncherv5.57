...
public final class StackedBarChartKt {
    ...
    public static final f getStackedBarChart(a aVar) {
        l.f("<this>", aVar);
        f fVar = _stackedBarChart;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.StackedBarChart", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
