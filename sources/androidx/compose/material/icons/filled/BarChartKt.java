...
public final class BarChartKt {
    ...
    public static final f getBarChart(a aVar) {
        l.f("<this>", aVar);
        f fVar = _barChart;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.BarChart", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        arrayList2.add(new n(16.0f, 13.0f));
        ...
        arrayList3.add(new z(16.0f));
        k0.a.h(-4.0f, arrayList3, jVar);
