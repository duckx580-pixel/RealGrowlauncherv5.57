...
public final class VerticalAlignCenterKt {
    ...
    public static final f getVerticalAlignCenter(a aVar) {
        l.f("<this>", aVar);
        f fVar = _verticalAlignCenter;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.VerticalAlignCenter", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        m0 m0Var = new m0(t.f6905b);
        n nVarC = gb.e.c(8.0f, 19.0f, 3.0f, 4.0f, 2.0f);
        k0.f.k(nVarC, -4.0f, 3.0f, -4.0f, -4.0f);
        k0.a.z(nVarC, -4.0f, 4.0f, 16.0f, 5.0f);
