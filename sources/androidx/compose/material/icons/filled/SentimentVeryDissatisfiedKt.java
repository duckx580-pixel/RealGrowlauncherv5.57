...
public final class SentimentVeryDissatisfiedKt {
    private static f _sentimentVeryDissatisfied;

    public static final f getSentimentVeryDissatisfied(a aVar) {
        l.f("<this>", aVar);
        f fVar = _sentimentVeryDissatisfied;
        if (fVar != null) {
            return fVar;
        }
        e eVar = new e("Filled.SentimentVeryDissatisfied", 24.0f, 24.0f, 24.0f, 24.0f, 0L, 0, false, 224);
        int i10 = h0.f9067a;
        long j = t.f6905b;
        m0 m0Var = new m0(j);
        ...
        f fVarB = eVar.b();
        _sentimentVeryDissatisfied = fVarB;
        return fVarB;
    }
}
