...
public abstract class a {
    ...
    public final int f(int i10, int i11) {
        return !e(i11) ? i10 : ((b) this).f8073e.readInt();
    }
    ...
    public final Parcelable g(Parcelable parcelable, int i10) {
        ...
        return ((b) this).f8073e.readParcelable(b.class.getClassLoader());
    }

    public final c h() {
        String string = ((b) this).f8073e.readString();
        if (string == null) {
            return null;
        }
        try {
    ...
    public final void j(int i10, int i11) {
        i(i11);
        ((b) this).f8073e.writeInt(i10);
    }

    public final void k(c cVar) {
        if (cVar == null) {
            ((b) this).f8073e.writeString(null);
            return;
        }
        try {
            ((b) this).f8073e.writeString(b(cVar.getClass()).getName());
            b bVarA = a();
            try {
                d(cVar.getClass()).invoke(null, cVar, bVarA);
                Parcel parcel = bVarA.f8073e;
                int i10 = bVarA.f8077i;
                if (i10 >= 0) {
                    int i11 = bVarA.f8072d.get(i10);
