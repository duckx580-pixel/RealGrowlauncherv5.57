...
public abstract class d {
    ...
    public static final Pattern f7715a = Pattern.compile("\\$(\\d+)|\\$\\{(\\d+):/(downcase|upcase)\\}");
    ...
    public static String b(CharSequence charSequence, CharSequence charSequence2, yj.a[] aVarArr) {
        int i10;
        String strSubstring;
        Matcher matcher = f7715a.matcher(charSequence);
        ...
        while (matcher.find()) {
            ...
            if (aVar != null) {
                CharSequence charSequenceSubSequence = charSequence2.subSequence(aVar.f20445a, aVar.f20446b);
