...
public final class b extends CharsetEncoder {
    ...
    public b(c cVar) {
        ...
        e eVar = new e();
        eVar.f8435a = CoderResult.UNDERFLOW;
        this.f8432a = eVar;
    }
    ...
    public final CoderResult encodeLoop(CharBuffer charBuffer, ByteBuffer byteBuffer) {
            ...
            while (true) {
                try {
                    ...
                    if (c10 <= 255) {
                        ...
                        iPosition++;
                    } else if (this.f8432a.a(c10, charBuffer) < 0) {
                        coderResultUnmappableForLength = this.f8432a.f8435a;
                    } else {
                        if (!this.f8432a.f8436b) {
                            i10 = 1;
                        }
        ...
        try {
            ...
            } else if (this.f8432a.b(cArrArray[i13], cArrArray, i13, iLimit) < 0) {
                coderResultUnmappableForLength2 = this.f8432a.f8435a;
            } else {
                if (!this.f8432a.f8436b) {
                    i10 = 1;
                }
