...
public final class y extends ReplacementSpan {
    ...
    public final x f5335r;

    /* JADX INFO: renamed from: u, reason: collision with root package name */
    public TextPaint f5338u;

    /* JADX INFO: renamed from: i, reason: collision with root package name */
    public final Paint.FontMetricsInt f5334i = new Paint.FontMetricsInt();

    /* JADX INFO: renamed from: s, reason: collision with root package name */
    public short f5336s = -1;

    /* JADX INFO: renamed from: t, reason: collision with root package name */
    public float f5337t = 1.0f;

    public y(x xVar) {
        o1.c.j("rasterizer cannot be null", xVar);
        this.f5335r = xVar;
    }
    ...
    */
    public final void draw(android.graphics.Canvas r19, java.lang.CharSequence r20, int r21, int r22, float r23, int r24, int r25, int r26, android.graphics.Paint r27) {
        /*
            ...
            goto L42
        L26:
            android.text.TextPaint r3 = r0.f5338u
            if (r3 != 0) goto L31
        ...
        L90:
            e4.x r2 = r0.f5335r
            u5.i r3 = r2.f5332b
            java.lang.Object r4 = r3.f17669t
            android.graphics.Typeface r4 = (android.graphics.Typeface) r4
            android.graphics.Typeface r5 = r10.getTypeface()
            r10.setTypeface(r4)
            int r2 = r2.f5331a
            int r13 = r2 * 2
            java.lang.Object r2 = r3.f17667r
            r12 = r2
            char[] r12 = (char[]) r12
            r14 = 2
            r11 = r19
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: e4.y.draw(android.graphics.Canvas, java.lang.CharSequence, int, int, float, int, int, int, android.graphics.Paint):void");
    }

    @Override // android.text.style.ReplacementSpan
    public final int getSize(Paint paint, CharSequence charSequence, int i10, int i11, Paint.FontMetricsInt fontMetricsInt) {
        Paint.FontMetricsInt fontMetricsInt2 = this.f5334i;
        paint.getFontMetricsInt(fontMetricsInt2);
        float fAbs = Math.abs(fontMetricsInt2.descent - fontMetricsInt2.ascent) * 1.0f;
        x xVar = this.f5335r;
        this.f5337t = fAbs / (xVar.b().a(14) != 0 ? ((ByteBuffer) r8.f6023t).getShort(r1 + r8.f6020i) : (short) 0);
        f4.a aVarB = xVar.b();
        int iA = aVarB.a(14);
        if (iA != 0) {
            ((ByteBuffer) aVarB.f6023t).getShort(iA + aVarB.f6020i);
        }
        short s2 = (short) ((xVar.b().a(12) != 0 ? ((ByteBuffer) r5.f6023t).getShort(r7 + r5.f6020i) : (short) 0) * this.f5337t);
        this.f5336s = s2;
