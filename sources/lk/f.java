...
public abstract class f {
    ...
    public static final e f10087a;

    /* JADX INFO: renamed from: b, reason: collision with root package name */
    public static final rk.c f10088b;

    /* JADX INFO: renamed from: c, reason: collision with root package name */
    public static final rk.c f10089c;

    static {
        rk.c cVar = new rk.c(50, 1);
        f10088b = cVar;
        f10089c = new rk.c(150, 1);
        b("ASCII-8BIT", "ASCII");
        b("UTF-8", "UTF8");
        b("US-ASCII", "USASCII");
        b("Big5", "BIG5");
        ...
        f10087a = (e) cVar.d(bytes, 0, bytes.length);
        a("BINARY", "ASCII-8BIT");
        f("IBM437", "ASCII-8BIT");
        a("CP437", "IBM437");
        f("IBM720", "ASCII-8BIT");
    ...
    public static void a(String str, String str2) {
        ...
        rk.c cVar = f10088b;
        cVar.getClass();
        e eVar = (e) cVar.d(bytes, 0, bytes.length);
        if (eVar == null) {
            throw new ok.c("no such encoding <%n>".replaceAll("%n", str2));
        }
        byte[] bytes2 = str.getBytes();
        rk.c cVar2 = f10089c;
        cVar2.getClass();
        if (cVar2.d(bytes2, 0, bytes2.length) != null) {
            throw new ok.c("encoding alias already registerd <%n>".replaceAll("%n", str));
        }
        cVar2.s(bytes2, eVar);
    }
    ...
    public static void b(String str, String str2) {
        ...
        rk.c cVar = f10088b;
        cVar.getClass();
        if (cVar.d(bytes, 0, bytes.length) != null) {
            throw new ok.c("encoding already registerd <%n>".replaceAll("%n", str));
        }
        cVar.s(bytes, new e(str2, null, false));
    }
    ...
    public static void c(String str) {
        ...
        cVar.getClass();
        if (cVar.d(bytes, 0, bytes.length) != null) {
            throw new ok.c("encoding already registerd <%n>".replaceAll("%n", new String(bytes)));
        }
        cVar.s(bytes, new e(f10087a.f10084b, bytes, true));
    }
    ...
    public static void d(String str) {
        ...
        e eVar = (e) cVar.d(bytes, 0, bytes.length);
        if (eVar == null) {
            throw new ok.c("no such encoding <%n>".replaceAll("%n", strConcat));
        }
        e(str, true, eVar);
    }

    public static void e(String str, boolean z3, e eVar) {
        byte[] bytes = str.getBytes();
        rk.c cVar = f10088b;
        cVar.getClass();
        if (cVar.d(bytes, 0, bytes.length) != null) {
            throw new ok.c("encoding replica already registerd <%n>".replaceAll("%n", str));
        }
        cVar.s(bytes, new e(eVar.f10084b, bytes, z3));
    }
